$(function () {
  ...
  //////////////// This is for managing partner and section head checking - BEGIN ////////////////////
     ...
     $.ajax({
         ...
         success: function(data){
            //alert(data);
             ...
             // console.log(obj);
             if(designation === 'MP' && obj.resp === 'FALSE'){
             sweetAlert("Oops...", "A firm cannot have more than one managing partner.", "error");
             } else if(designation === 'SECH' && obj.resp === 'FALSE'){
                sweetAlert("Oops...", "This section already has a section head.", "error");
             }
         }
     });
  });
   //////////////// This is for managing partner and section head checking - END ////////////////////
