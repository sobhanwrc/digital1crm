                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo $base_url; ?>emailtemplate/contract/">Contract Template</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>List</span>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Contract Template List</span>
                                    </div>
                                </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <?php if ($role_code == 'FIRMADM') { ?>
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>emailtemplate/edit_contract/<?php echo base64_encode($val['id']); ?>">
