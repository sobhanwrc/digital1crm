                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                   ...
                                   <form role="form" id="appprofile_info_form" method="post" action="<?php echo $base_url . 'firm-sections/details/' . base64_encode($strategy_group['firm_section_seq_no']); ?>">
...
<!--                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="section_id" class="form-control" disabled value="<?php if(isset($strategy_group['section_id']) && $strategy_group['section_id'] != ''){echo $strategy_group['section_id']; } ?>" <?php if(isset($strategy_group['section_id']) && $strategy_group['section_id'] != ''){echo $strategy_group['section_id']; } ?> />
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="code description" name="code_description" value="<?php if(isset($strategy_group['section_name']) && $strategy_group['section_name'] != ''){echo $strategy_group['section_name']; } ?>" <?php if(isset($strategy_group['section_name']) && $strategy_group['section_name'] != ''){echo $strategy_group['section_name']; } ?> />
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
