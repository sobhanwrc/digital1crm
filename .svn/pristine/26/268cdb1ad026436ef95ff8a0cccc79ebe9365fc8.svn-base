                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <a href="<?php echo $base_url; ?>Industry_Type/add" class="btn btn-outline sbold"  >
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php $i = 0;
                                            foreach ($industry_type_list as $key => $val) {
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <?php if ($role_code == 'SITEADM') { ?>
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>Industry_Type/edit/<?php echo base64_encode($val['industry_type_seq_no']); ?>">
                                                                            <i class="icon-docs"></i> Edit </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>Industry_Type/delete/<?php echo base64_encode($val['industry_type_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
