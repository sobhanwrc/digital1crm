                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Firm Practice Area List</span>
                                    </div>
                                    <!--                                    <div class="actions">
                                            ...
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                        <a href="#responsive_request" class="btn btn-outline sbold" data-toggle="modal" >
                                                            <button class="btn sbold green"> Request New Practice Area
                            ...
                            <br>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php 
                                            $i = 1;
                                            foreach ($all_practice_area as $key => $value) { ?>
                                                <tr>  
                                                    <td> <?php echo $i++; ?> </td>
                                                     <?php if($role_code  == 'SITEADM'){?>
    ...
    <div id="responsive_request" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title">Request a new Practice Area</h4>
                        </div>
                        <form autocomplete="off" name="request_practice_area_form" id="request_practice_area_form" action="<?php echo $base_url; ?>firm_pa/request_practice_area" method="post">
                            <div class="modal-body">
                                <div class="scroller" style="height:200px" data-always-visible="1" data-rail-visible1="1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group required">
                                                <label class="col-md-4 control-label">Make Request To:</label>
                                                <div class="col-md-8">
                            ...
                            <div class="modal-footer">
                                <button type="button" data-dismiss="modal" class="btn dark btn-outline">Close</button>
                                <button type="submit" name="request_practice_area_submit" id="request_practice_area_submit" class="btn green">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
