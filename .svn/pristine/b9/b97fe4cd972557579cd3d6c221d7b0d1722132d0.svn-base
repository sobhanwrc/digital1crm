                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Module 4</span>
                            </div>
                        </div>
...
//                                      t($value); exit;
                                       ?>
                                    <tr style=" cursor: pointer" onclick="javascript:window.location.href='<?php echo $base_url; ?>competitor/contract_view/<?php echo base64_encode($value['target_seq_no']); ?>'">
                                        ...
                                        <td><?php echo $value['contract_status'] == "1" ? 'YES': 'NO'; ?></td>
