...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
     ...
     * @var array
     */
    public static $_invalidCharacters = array('*', ':', '/', '\\', '?', '[', ']');
     ...
     * @var PHPExcel_Worksheet_RowDimension
     */
    public $_defaultRowDimension = null;
     ...
     */
    public $_columnDimensions = array();
     ...
     * @var PHPExcel_Worksheet_ColumnDimension
     */
    public $_defaultColumnDimension = null;
     ...
     */
    public $_drawingCollection = null;
     ...
     * @var array
     */
    public $_conditionalStylesCollection = array();
     ...
     * @var boolean
     */
    public $_cellCollectionIsSorted = false;
    ...
    * @var boolean
    */
    public $_showRowColHeaders = true;
     ...
     * @var array
     */
    public $_hyperlinkCollection = array();
     ...
     * @var array
     */
    public $_dataValidationCollection = array();
   ...
   /**
     ...
     * @throws Exception
     */
    public static function _checkSheetCodeName($pValue)
    {
   ...
   /**
     ...
     */
	public function _createNewCell($pCoordinate)
	{
