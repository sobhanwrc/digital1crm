                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <!--<span class="caption-subject bold uppercase">Target Contact List<small style="margin-left: 10px;">For Organization <?php echo $name[0]['target_company_name'];?></small></span>-->
                                        <span class="caption-subject bold">Contact List For Organization <?php echo $name[0]['target_company_name'];?></span>
                                    </div>
                                    <!--                                    <div class="actions">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <?php if ($role_code == 'FIRMADM' || $role_code == 'ATTRMGR' || $role_code == 'ATTR') { ?>
                                                    <div class="btn-group">
                                                        <a href="<?php echo $base_url; ?>targets/add_cont" class="btn btn-outline sbold" data-toggle="modal" > 
