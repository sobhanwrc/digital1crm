                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Competitor List</span>
                            </div>
                            <!--                                    <div class="actions">
                            ...
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6" style=" padding-left: 0">
                                        <div class="btn-group">
                                            <a href="<?php echo $base_url; ?>competitor/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
...
//                                    t($value); exit;
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $value['competitor_dob']; ?></td>
                                        <td><?php echo $value['best']; ?></td>
                                        <td><?php echo $value['bar_date']; ?></td>
