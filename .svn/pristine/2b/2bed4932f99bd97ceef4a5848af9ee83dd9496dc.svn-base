                        ...
                        <div class="portlet-body">
                               <div class="row">
                                    <div class="add_form_sec">
                                        <form role="form" id="add_new_cli_contact" autocomplete="off" method="post" action="<?php echo $base_url . 'targets/insert_cont' ?>" enctype="multipart/form-data">
                                                      ...
                                                      <select name="client" id="client" class="form-control" required>
                                                        <option value="">Select Target</option>
                                                          <?php foreach($all_client as $key=>$value){ ?>
                                                            <option value="<?php echo $value['target_seq_no']; ?>"><?php echo $value['target_first_name']." ".$value['target_last_name']; ?></option>
                                                          <?php } ?>
                                                      </select>
                                                  </div>
