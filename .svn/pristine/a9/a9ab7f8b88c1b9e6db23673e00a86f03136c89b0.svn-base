                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input readonly="" type="text" value="<?php echo $mobile; ?>" placeholder="Mobile" class="form-control"  name="mobile" id="mobile" style="width: 85%; margin-left: -5px; display: inline-block" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" value="<?php echo $country_code2; ?>" placeholder="" class="form-control" id="country_code1" name="country_code1" autocomplete="off" style="width: 15%; display: inline-block">
                                                                    <input readonly type="text" value="<?php echo $phone1_number; ?>" placeholder="Phone1" class="form-control"  name="phone1" id="phone1"  style="width: 85%; margin-left: -5px; display: inline-block"/>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" value="<?php echo $country_code1; ?>" placeholder="" class="form-control" id="country_code2" name="country_code2" autocomplete="off" style="width: 15%; display: inline-block">
                                                                    <input readonly type="text" value="<?php echo $phone2_number; ?>" placeholder="Phone2" class="form-control"  name="phone2" id="phone2"  style="width: 85%; margin-left: -5px; display: inline-block"/>
