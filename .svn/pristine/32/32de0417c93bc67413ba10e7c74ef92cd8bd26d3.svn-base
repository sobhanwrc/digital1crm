                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Postcode Group List</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <a href="<?php echo $base_url; ?>PostGroup/add" class="btn btn-outline sbold"  >
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php $i = 0;
                                            foreach ($post_group_list as $key => $val) {
                                            $created_date =  date('d/m/Y', $val['created_date']);
                                              ?>
                                                <tr>
                                                    <td> <?php echo ++$i; ?> </td>
                                                    <td> <?php echo $val['group_name']; ?> </td>
                                                    <td> <?php echo $val['group_contains']; ?> </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <?php if ($role_code == 'SITEADM') { ?>
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>PostGroup/edit/<?php echo base64_encode($val['post_group_seq_no']); ?>">
                                                                            <i class="icon-docs"></i> Edit </a>
                                                                    </li>

                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>PostGroup/delete/<?php echo base64_encode($val['post_group_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
