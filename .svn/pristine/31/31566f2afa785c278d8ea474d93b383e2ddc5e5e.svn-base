                                    ...
                                    <div class="table-toolbar">
                                             ...
                                             <?php $smsg = $this->session->flashdata('err_message'); if(isset($smsg) && $smsg != ''){ ?>
                                              ...
                                              <?php } ?>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <textarea class="form-control" name="activity_reason_desc" placeholder="Enter text" disabled="disabled"><?php echo $this_activity['activity_reason_desc']; ?></textarea>
                                                         <span class="help-block">  </span>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <input type="text" value="<?php echo $this_activity['potential_revenue']; ?>" class="form-control" name="potential_revenue" placeholder="Enter text" readonly="readonly">
                                                         <span class="help-block"> </span>
                                                     </div>
                                                 </div>
                                                 <div class="form-group">
                                                        	...
                                                        	<tr>
                                                            	<td width="100%">
                                                                	<table width="100%">
                                                                        ...
                                                                        <tr>
                                                                        	<td width="100%">
                                                                            	<input style=" width:79%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="duration_from" placeholder="DD-MMM-YYYY" value="<?php echo $this_activity['duration_from']; ?>" disabled="disabled">
                                                                  <span class="input-group-btn">
                                                                      <button class="btn default" type="button">
                                                                          <i class="fa fa-calendar"></i>
                                                                      </button>
                                                        	...
                                                        	<tr>
                                                            	<td width="100%">
                                                                	<table width="100%">
                                                                        ...
                                                                        <tr>
                                                                        	<td width="100%">
                                                                            	 <input style="width:78%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="duration_to" placeholder="DD-MMM-YYYY" value="<?php echo $this_activity['duration_to']; ?>" disabled="disabled">
                                                                  <span class="input-group-btn">
                                                                      <button class="btn default" type="button">
                                                                          <i class="fa fa-calendar"></i>
                                                                      </button>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <textarea class="form-control" name="remarks_notes" placeholder="Enter text" disabled="disabled"><?php echo $this_activity['remarks_notes']; ?></textarea>
                                                         <span class="help-block">  </span>
                                                     </div>
                                                 </div>
                                                 <div class="form-group">
                                                     <label class="col-md-4 control-label">Invite Attorney:</label>
                                                     <div class="col-md-8">
                                                         <div class="btn-group">
                                                             <a href="#<?php if($this_activity['activity_status'] == 'NEWACT'){ ?>responsive<?php } ?>" class="btn btn-outline sbold" data-toggle="modal" <?php if($this_activity['activity_status'] == 'PENDACT'){ ?> onclick="alert('This activity is under approval process');" <?php } ?> <?php if($this_activity['activity_status'] == 'APPRACT'){ ?> onclick="alert('This activity is approved');" <?php } ?> <?php if($this_activity['activity_status'] == 'NAPPRACT'){ ?> onclick="alert('This activity is rejected');" <?php } ?>>
                                                                 <button class="btn sbold green"> Invite Attorney
                                        ...
                                        <div style=" width:100%; display:inline-block;">
                                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                                ...
                                                <tbody>
                                                    <?php $i=0; foreach ($invitee_budget_sum_up as $key => $value) { ?>
                                                    <tr>
                                                        <td><?php echo ++$i; ?></td>
                                                        <td><?php echo $value['attorney_first_name'] . ' ' . $value['attorney_last_name']; ?></td>
                                                        
                                                        <td><?php echo $value['budgeted_cost'] ; ?></td>
                                                        ...
                                                        <!--<td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    ...
                                                                    <li>
                                                                        <a href="<?php echo $base_url . 'activity/invitee-budget-details/' . base64_encode($value['attorney_seq_no']) . '/' . base64_encode($value['activity_seq_no']); ?>" data-toggle="modal" >
               ...
               <div id="responsive" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form  name="add_attr_act_frm" id="add_attr_act_frm" action="#" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control" name="attorney_seq_no[]" multiple="multiple" id="attorney_seq_no_" required>
                                                        <!--<option value="">Select One</option>-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" name="remarks_notes"></textarea>  
                                                    <span class="help-block"> </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn green" id="add_attr_act_btn">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    <script type="text/javascript">
        ...
        $('#add_attr_act_btn').click(function(){ //alert($('#attorney_seq_no_').val());
            //if(!$('.relation_type').is(':checked')) { alert('Select relation type');  exit;}
            if($('#attorney_seq_no_').val() == '') { alert('Select attorney'); exit;}
            //if($('#potential_rev').val() == ''){ alert('Enter potential revenue'); exit; }

            $.ajax({
                url : BASE_URL + 'activity/add_att_act',
                type : 'POST',
                dataType : 'json',
                data : $('#add_attr_act_frm').serialize(),
                success : function(data)
                {
                   if (data.msg = 'added') {$('#responsive').modal('hide'); location.reload(true);}
                }
            });
        });
    </script>
