                                    ...
                                    <div class="table-toolbar">
                                    	<div class="add_input_deactive_area">
                                         <div class="add_form_sec">
                                             <form autocomplete="off" role="form" id="add_new_activity_frm" method="post" action="<?php echo $base_url . 'activity/edit/'  . base64_encode($this_activity['activity_seq_no']); ?>" enctype="multipart/form-data">
                                           
                                           <div class="col-md-12" style="position: relative;">
                                            <h3 class="hint"> General Information </h3>
                                            <div class="form-group" style="position: absolute; right: 18px; z-index: 9999; top: 0">
<!--                                                     <label class="col-md-4 control-label">Add Client/Traget: <?php echo $this_activity['activity_status']; ?></label>-->
                                                         <div class="btn-group">
                                                             <a href="<?php $i=0; if($this_activity['activity_status'] == 'NEWACT'){ ?>#responsive<?php echo ++$i;} ?>" class="btn btn-outline sbold" data-toggle="modal" <?php if($this_activity['activity_status'] == 'PENDACT'){ ?> onclick="alert('This activity is under approval process');" <?php } ?> <?php if($this_activity['activity_status'] == 'APPRACT'){ ?> onclick="alert('This activity is approved');" <?php } ?> <?php if($this_activity['activity_status'] == 'NAPPRACT'){ ?> onclick="alert('This activity is rejected');" <?php } ?>>
                                             ...
                                             <?php $smsg = $this->session->flashdata('err_message'); if(isset($smsg) && $smsg != ''){ ?>
                                              ...
                                              <?php } ?>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <textarea class="form-control" style="height:80px;" name="remarks_notes" placeholder="Enter text" disabled="disabled"><?php echo $this_activity['remarks_notes']; ?></textarea>
                                                         <span class="help-block">  </span>
                                                     </div>
                                                 </div>
                                        ...
                                        <div style=" width:100%; display:block;">
                                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr <?php if($value['attorney_seq_no'] != $value['origin_attorney_seq_no']){ ?> style="background-color:#EEF1F5" <?php } ?>>
                                                        <td><?php echo ++$i; ?></td>
                                                        ...
                                                        <td>
                                                        <?php if($value['attorney_seq_no'] == $value['origin_attorney_seq_no']){ ?>
                                                        <a <?php if($this_activity['activity_status'] == 'PENDACT'){ ?> onclick="alert('This activity is under approval process');" <?php } ?> <?php if($this_activity['activity_status'] == 'APPRACT'){ ?> onclick="alert('This activity is approved');" <?php } ?> <?php if($this_activity['activity_status'] == 'NAPPRACT'){ ?> onclick="alert('This activity is rejected');" <?php } ?> href="#<?php if($this_activity['activity_status'] == 'NEWACT'){ ?>individual_budget_dtl<?php echo $i; } ?>" data-toggle="modal" style="text-decoration:none;<?php if($value['budgeted_cost'] == 0){ echo 'color:red;';} ?>"><?php echo $value['budgeted_cost'] ; ?><?php if($value['budgeted_cost'] == 0){ echo ' (Add Budget)';} ?></a> <?php } else{
                                                            echo $value['budgeted_cost'];
                                                        } ?>
                                                        </td>
                                                        <td><?php echo $value['potential_revenue'] ; ?></td>
                                                        <td><?php if($value['attorney_seq_no'] == $value['origin_attorney_seq_no']){ ?> 
                                                            <div class="btn-group">
...
<?php $i=0; foreach ($act_dtl_res as $key => $value) { ?>
<div id="responsive<?php echo ++$i; ?>" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        ...
                        <form  name="ind_ct_potential_rev_frm" id="ind_ct_potential_rev_frm" action="#" method="post">
                            ...
                            <input type="hidden" name="origin_attorney_seq_no" value="<?php echo $this_activity['origin_attorney_seq_no']; ?>">
                            <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group" style="margin-top:15px; width:100%; display:inline-block;">
                                                <label class="col-md-4 control-label">Relation:</label>
                                                <div class="col-md-8">
                                                    <?php if($act_dtl_res[0]['relation_type']== 'T') {?>
                                            ...
                                            <div class="form-group" style=" width:100%; display:inline-block;">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="text" disabled="" class="form-control" name="ct_name" value="<?php echo $act_dtl_res[0]['ct_name']; ?>">
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>
                                             <div class="form-group" style=" width:100%; display:inline-block;">
                                                <label class="col-md-4 control-label">Budget Cost US $:</label>
                                                <div class="col-md-8">
                                                    <input type="text" disabled="" class="form-control" name="remarks" value="<?php echo $act_dtl_res[0]['budgeted_cost']; ?>">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div> 
                                            <div class="form-group" style=" width:100%; display:inline-block;">
                                                <label class="col-md-4 control-label">Potential Revenue:</label>
                                                <div class="col-md-8">
                                                    <input type="text" disabled="" class="form-control" name="potential_rev" id="potential_rev" value="<?php echo $this_activity['potential_revenue']; ?>">
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>
...
<script>
    ...
    <script type="text/javascript">
        ...
        /****** Hide/show div on page load (activity type) - End ******/
            ...
            $('#ind_ct_potential_rev').click(function(){
                ...
                $.ajax({
                    ...
                    success : function(data)
                    {
                       if (data.msg = 'ok') {$('#responsive').modal('hide'); location.reload(true);}
                    }
                });    
        ...
        {
            $.ajax({
                url : BASE_URL + 'activity/get_rel_type_users/<?php echo base64_encode($this_activity['activity_seq_no']); ?>',
                type : 'POST',
                dataType : 'json',
                data : {reltyp : reltyp},
                success : function(data)
