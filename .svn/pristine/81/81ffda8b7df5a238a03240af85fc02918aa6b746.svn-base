...
//                                                            t($city_info);exit;
                                                            ...
                                                            <div class="form-group required">
                                                                    ...
                                                                    <input type="text" name="country_seq_no" id="country_seq_no" class="form-control">
                                                            </div>
                                                            
                                                            <div class="form-group required">
                                                                    <label class="control-label">State</label>                                                                    
                                                                    <input type="text" class="form-control" id="state_seq_no" name="state_seq_no">
                                                            </div>
                                                            <div class="form-group required">
                                                                    <label class="control-label">City</label>                                                                   
                                                                    <input type="text" class="form-control" id="city_seq_no" name="city_seq_no">
                                                            </div>
                                                            <div class="form-group required">
                                                                    <label class="control-label">Zipcode</label>                                                                    
                                                                    <input type="text" name="zips_seq_no" id="zips_seq_no" class="form-control">
                                                            </div>
                                                            ...
                                                            <div class="form-group required">
                                                                ...
                                                                <input type="text" placeholder="Enter Contact No" class="form-control"  name="contact_no" id="contact_no" style="width: 78%; margin-left: -5px; display: inline-block" />
                                                        ...
                                                        <div class="margiv-top-10">
                                                                <button type="submit" id="general-edit-submit-btn" class="btn green" name="general_save_change" value="general_save_change">Add Venue</button>
                                                                <input type="reset" name="reset" value="Reset" class="btn green">
                                                        </div>
                                                    </div> 
                                                </div>     
                                            </form>
...
<?php echo $footer_link; ?>
        ...
        $(document).ready(function () {
            $("#general-edit-submit-btn").click(function(e){
                e.preventDefault();
                if($("#venue-general-info-edit-form").valid()){
