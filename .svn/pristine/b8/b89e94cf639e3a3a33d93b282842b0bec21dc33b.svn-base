                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">
                                            Import Excel Data
                                            <font color="red" style="margin-left: 150px;">Import Only United States of America Data</font>
                                        </span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <?php if ($method_name == 'add') { ?>
                                                <form action="<?php echo $base_url; ?>import-csv/insertData" name="insertdata" id="insertdata" method="post"  enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <input type="hidden" value="<?php echo $NewFileName; ?>" class="form-control" name="csv_file_name" id="csv_file_name">
                                                            <div class="form-group required">
                                                                <label class="col-md-4 control-label">Select As Firm</label>
                                                                <div class="col-md-8">
                                                                    <select name="firm_email" id="firm_email" required="">
                                                                        <option>Select Firm Email</option>
                                                                        <?php foreach ($email as $key => $value) {
                                                                            $value1=  explode('-', $value);
//                                                                            t($value1);
                                                                            $value1=  $value1[0];
                                                                            ?>
                                                                        <option value="<?php echo $value1; ?>"><?php echo $value; ?></option>                                              
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <div class="margiv-top-10">
                                                                <button type="submit" name="add_new_cli_btn1" id="add_new_cli_btn1" class="btn green">Save</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php } else { ?>
                                                <form action="<?php echo $base_url; ?>import-csv/add" name="strategygroupadd-form" id="strategygroupadd-form" method="post"  enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group required">
                                                            ...
                                                            <div class="margiv-top-10">
                                                                <button type="submit" name="add_new_cli_btn2" id="add_new_cli_btn2" class="btn green">Save</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
