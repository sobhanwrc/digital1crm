...
<!--                                                                        <label class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                        ...
                        <div class="portlet-body">
                           ...
                           <div class="add_form_sec">
                               <form role="form" id="myfirm-general-info-form" autocomplete="off" method="post" action="<?php echo $base_url . 'targets/add/' ?>">
                               <div class="form-group required">
                                                 
                                                 <div class="radio-list col-md-8">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="inor"  class="form-control act_goal" id="ind" value="I" checked> Individual Target </label>
                                                    <label class="radio-inline">
                                   ...
                                   <div class="col-md-6">
                                       ...
                                       <div class="form-group required bb">
                                            ...
                                            <input type="text" placeholder="Enter First Name" class="form-control" name="target_first_name" id="target_first_name" /> </div>
                                       ...
                                       <div class="form-group required bb">
                                            ...
                                            <input type="text" placeholder="Enter Last Name" class="form-control" name="target_last_name" id="target_last_name" /> </div>
                                        <div class="form-group required bb">
                                            <label class="control-label">Target ID</label>
                                            <input type="text" placeholder="Enter Target ID" class="form-control" name="target_id" id="target_id"  /> </div>
                                       ...
                                       <div class="form-group required bb">
                                            <label class="control-label bb">Target Code</label>
                                            <input type="text" placeholder="Enter Target Code" class="form-control" name="target_code" id="target_code"  /> </div>
                                        ...
                                        <div class="form-group required bb">
                                            ...
                                            <select name="target_gender" id="target_gender" class="form-control">
                                                ...
                                                <?php foreach($codes['Gender'] as $key=>$value){ ?>
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <select name="target_status" id="target_status" class="form-control">
                                                ...
                                                <?php foreach($codes['TARGET STATUS'] as $key=>$value){ ?>
                                                <option value="<?php echo $value['code']; ?>"><?php echo $value['short_description']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <select name="industry_type" id="industry_type" class="form-control">
                                                ...
                                                <?php foreach($codes['Industry Type'] as $key=>$value){ ?>
                                                <option value="<?php echo $value['code']; ?>"><?php echo $value['short_description']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                       ...
                                       <div class="form-group required bb">
                                           ...
                                           <input type="text" placeholder="Enter Target Company" class="form-control" name="target_company_name" id="target_company_name" />
                                       </div>
                                       <div class="form-group">
                                     ...
                                     <h3 class="hint"> Remarks </h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Remarks" name="remarks1" id="remarks1"></textarea>
                                        </div>
