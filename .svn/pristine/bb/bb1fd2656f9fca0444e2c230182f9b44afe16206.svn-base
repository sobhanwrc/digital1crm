                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Module 5</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                ...
                                <tbody>
                                    <?php // t($competitor, 1); ?>
                                    <?php $SlNo = 1;
                                    if(!empty($fetch_details_from_module5))
                                    {
                                      foreach($fetch_details_from_module5 as $key => $value)
                                       {

//                                      t($value); exit;
                                       ?>
                                    <tr style=" cursor: pointer" onclick="javascript:window.location.href='<?php echo $base_url; ?>Competitor/detials_module5/<?php echo base64_encode($value['target_seq_no']); ?>/<?php echo base64_encode($value['firm_seq_no']); ?>'">
                                        ...
                                        <td><?php echo $value['e_signature'];  ?></td>
