                            ...
                            <tr>
                                ...
                                <td style="width: 35px" height="40px" valign="top">
                                    <?php if ($prev_target_seq_no) { ?>
                                        <a style="width: 100%; display: block" href="<?php echo $base_url; ?>competitor/detials_module5/<?php echo base64_encode($prev_target_seq_no); ?>/<?php echo base64_encode($fetch_details[0]['firm_seq_no']); ?>" id="prev"><i style=" font-size: 36px; margin-top: 10px;" class="fa fa-angle-left"></i></a>
                                    <?php } ?>
                                </td>
                                ...
                                <td style=" width: 90px">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        ...
                                        <!--<input name="options" class="toggle" id="option1" type="radio">-->
                                            <a style=" text-decoration: none; color:#fff" href="" onclick="javascript:window.location.href = '<?php echo $base_url; ?>competitor/product_purchase'"> Back to Listing</a></label>
                                    </div>
                                </td>
                                ...
                                <td style=" width: 35px" height="40px" valign="top">
                                    <?php if ($next_target_seq_no) { ?>
                                        <a style="width: 100%; display: block" href="<?php echo $base_url; ?>competitor/detials_module5/<?php echo base64_encode($next_target_seq_no); ?>/<?php echo base64_encode($fetch_details[0]['firm_seq_no']); ?>" id="next"><i style=" font-size: 36px; margin-top: 10px;" class="fa fa-angle-right pull-right"></i></a>
                                    <?php } ?>
                                </td>
...
<?php if ($fetch_details[0]['type'] == "C") { ?>
                                                    <span style=" font-size: 20px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;"><?php echo $fetch_details[0]['company_name'] ?>,</span>

                                                    <span style=" width: auto; padding: 0 5px; font-weight: bold; display: inline-block;">
                                                        <div>
    <?php echo $fetch_details[0]['name']; ?>
                                                        </div>


                                                    </span>
<?php } else { ?>
                                                    <span style=" font-size: 16px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;"><?php echo $fetch_details[0]['name']; ?>,</span>

                                                    <span style=" width: auto; padding: 0 5px; font-weight: bold; display: inline-block;">
                                                        <div>
    <?php echo $fetch_details[0]['company_name']; ?>
                                                        </div>

                                                    </span>
<?php } ?>

                                                <span style=" width: auto; padding: 0 5px; display: inline-block;"><strong>Email: </strong><?php echo $fetch_details[0]['email']; ?></span>

                                                <span style=" width: auto; padding: 0 5px; display: inline-block;">
                                                    <strong>Phone:</strong> <?php echo $fetch_details[0]['phone']; ?>

                                                    <a class="call_now" href="javascript:void(0)" val='<?php echo $fetch_details[0]['target_seq_no']; ?>' from_model="module5" name="<?php echo $fetch_details[0]['name']; ?>"><i style="font-size: 23px; margin-left: 10px; color:#337ab7" class="fa fa-phone-square"></i></a>
    ...
    <?php } else { ?>
                                                    <div style="width: 100%; display: inline-block;">
                                                        ...
                                                        <span style=" font-size: 16px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;">
                                                            ...
                                                            <div><?php echo $fetch_details[0]['name']; ?></div>

                                                        </span>
                                                        <span style=" width: auto; padding: 0 5px; display: inline-block;"><strong>Email: </strong><?php echo $fetch_details[0]['email']; ?></span>

                                                        <span style=" width: auto; padding: 0 5px; display: inline-block;">
                                                            <div class="caption-subject bold" style=" width: 100%; display: inline-block;">Phone: <?php echo $fetch_details[0]['phone']; ?>
                                                                <a href=""><i style="font-size: 23px; margin-left: 10px; color:#337ab7" class="fa fa-phone-square"></i></a>
                                                            </div>
...
<?php } ?><button class="btn btn-transparent dark btn-outline btn-circle active1" data-target="#product_purchase_date_div" data-toggle="modal" >
                                                <img src="<?php echo $assets_path; ?>pages/img/Client_-purchased.png" alt="" class="menu_icon" />Client has purchased
                                            </button>
...
//                                                        $i = 0;
                                            ...
                                            <div class="col-md-4" style=" padding-right: 0">
                                                <div class="comm_section">
                                                    <ul class="list-inline pull-right">
                                                        ...
                                                        <li><a href="<?php echo $base_url; ?>Competitor/temp_email5/<?php echo base64_encode($target_seq_nos); ?>/<?php echo base64_encode($company_ids); ?>" ><i class="fa fa-envelope-o"></i> Email</a></li>
                                                ...
                                                <div class="portlet light bordered">
                                                    <div class="next_date_area">
                                                        <ul class="list-unstyled">
                                                            <!-- <li><button class="btn btn-transparent dark btn-outline btn-circle active1" data-target="#product_purchase_date_div" data-toggle="modal" >
                                                            <img src="<?php echo $assets_path; ?>pages/img/Client_-purchased.png" alt="" class="menu_icon" />Client has purchased
                                                            </button>
                                                            </li> -->
                                                            <!--<li><button class="btn btn-transparent dark btn-outline btn-circle active" data-target="#appointment_date_and_time_div" data-toggle="modal" >Make Appointment</button>-->
                                                            </li>

                                                            <li><button class="btn btn-transparent dark btn-outline btn-circle active" id="" data-target="#module5_addContactModal" data-toggle="modal" >
                                                            ...
                                                            <li><button class="btn btn-transparent dark btn-outline btn-circle active" data-target="#do_not_call_add_note" data-toggle="modal" >
                                                                    <img src="<?php echo $assets_path; ?>pages/img/Not_Call_Me.png" alt="" class="menu_icon" />
                                                                    Do Not Call Me</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <form name="master_name_edit" autocomplete="off" id="master_name_edit" method="post" action="<?php echo $base_url; ?>master_name/add">
                                                    <input type="hidden" name="target_seq_no" id="target_seq_no" value="<?php echo $fetch_details[0]['target_seq_no']; ?>">
                                                    <input type="hidden" name="seq_no" id="seq_no" value="<?php echo $fetch_details[0]['id']; ?>">
                                                    ...
                                                    <div class="modal-body">
                                                        <div id="create_event" class=" mt10">
                                                            ...
                                                            <div class="form-group bb">
                                                                ...
                                                                <input type="text" readonly placeholder="Enter Firm Name" class="form-control"  name="last_name" id="last_name" value="<?php echo $fetch_details[0]['name']; ?>">

                                                            </div>

                                                            <div class="form-group bb">
                                                                <label class="control-label">Email</label>
                                                                <input type="text" readonly placeholder="Enter Firm ID" class="form-control" name="email" id="email" value="<?php echo $fetch_details[0]['email']; ?>"  />
                                                            </div>

                                                            <div class="form-group bb">
                                                                <label class="control-label" style=" width: 100%; display: inline-block">Phone</label>
                                                                <!--<input type="text" placeholder="" class="form-control" disabled="" name="target_code" id="target_code" value="<?php echo $fetch_details[0]['phone']; ?>" />--> 
                                                            ...
                                                            <div class="form-group bb">
                                                                ...
                                                                <input type="text" readonly placeholder="" class="form-control" name="mobile" id="mobile" value="<?php echo $fetch_details[0]['mobile']; ?>" /> 
                                                            </div>
                                                            <div class="form-group bb">
                                                                <label class="control-label">Address</label>
                                                                <input type="text" readonly placeholder="" class="form-control"  name="address1" id="address1" value="<?php echo $fetch_details[0]['address1']; ?>" /> 
                                                            </div>
                                                            <div class="form-group bb">
                                                                <label class="control-label">Company Name</label>
                                                                <input type="text" readonly placeholder="Enter Target Company" class="form-control" name="target_company_name" id="target_company_name" value="<?php echo $fetch_details[0]['company_name']; ?>" />
                                                            </div> 
                                                            <div class="form-group">
                                                                <label class="control-label">Categories</label>
                                                                <input type="text" readonly placeholder="Enter Target Company" class="form-control"  name="industry_type" id="industry_type" value="<?php echo $fetch_details[0]['categories']; ?>" />
                                                            </div>
                                    ...
                                    <div class="modal fade" id="calendarModal_add_note" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <form name="master_name_add_notes" autocomplete="off" id="master_name_add_notes" method="post" action="">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    ...
                                    <!--                                    add product purchase div-->
                                    <div class="modal fade" id="product_purchase_date_div" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <form name="product_purchase_div" autocomplete="off" id="product_purchase_div" method="post" action="<?php echo $base_url; ?>master_name/add">
                                                    <input type="hidden" name="user_company_id" id="user_company_id" value="<?php echo $fetch_details[0]['firm_seq_no']; ?>">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                        <div class="modal-title"><span class="glyphicon glyphicon-pencil text-purple2 mr10"></span><b> Client has purchased </b></div>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div id="create_event" class=" mt10" style=" display: inline-block; width: 100%;">

                                                            <div class="col-md-7" style=" padding-left: 0;">
                                                                <div style="width: 100%"><label>Product Purchased Date</label></div>
                                                                <div class="input-group " style="width: 100%">
                                                                    <!-- <input type="text" name="next_call_date" value=""  placeholder="" class="form-control "> --> 
                                                                    <input style="width: 90%"  aria-describedby="datepicker-error" aria-required="true" aria-invalid="false"  type="text" id="next_call_date" name="next_call_date" value="<?php echo $targets[0]['next_call_date']; ?>"  placeholder="DD-MM-YYYY" class="form-control " readonly>
                                                            ...
                                                            <div class="col-md-12" style=" padding-left: 0; padding-right: 0">
                                                                <div class="form-group">
                                                                    <label for="comment">Product purchase </label>
                                                                    <input type="checkbox" class="" name="product_purchase" id="product_purchase">
                                                                </div>
                                                                <label class="error" for="product_purchase" generated="true"></label>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <div class="input-group col-md-12 pull-right" style="padding-right:13px">
                                                            ...
                                                            <input type="button" value="Submit" class="submit btn green pull-right" name="product_purchase_submit" id="product_purchase_submit" >
                                    ...
                                    <!--                                    add contact div-->
                                    <div class="modal fade" id="module5_addContactModal" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                ...
                                                <div class="modal-body">
                                                    <div id="create_event" class=" mt10">
                                                        <div class="col-md-12">
                                                            <form name="module5_frmAddContact" id="module5_frmAddContact" method="POST" novalidate>
                                                                <div class="form-group">
                                                                    <div style="width: 100%"><label>First Name</label></div>
                                                                    <div class="input-group" style="width: 100%;">
                                                                        <input type="text" value="<?php echo $fetch_add_contact_details['first_name']; ?>" name="contact_first_name" id="contact_first_name" class="form-control text-area">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div style="width: 100%"><label>Last Name</label></div>
                                                                    <div class="input-group" style="width: 100%;">
                                                                        <input type="text" value="<?php echo $fetch_add_contact_details['last_name']; ?>" name="contact_last_name" id="contact_last_name" class="form-control text-area">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div style="width: 100%"><label>Email</label></div>
                                                                    <div class="input-group" style="width: 100%;">
                                                                        <input type="text" value="<?php echo $fetch_add_contact_details['email']; ?>" name="contact_email" id="contact_email" class="form-control text-area">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group bb">
                                                                    <label class="control-label" style=" width: 100%; display: inline-block">Phone</label>
                                                                    ...
                                                                    ?>" placeholder="Country code" class="form-control" id="country_code2" name="country_code1" autocomplete="off" style="width: 25%; display: inline-block;">
                                                                    <input type="text" placeholder="Enter phone number" value="<?php echo $primary_contact_phone_number; ?>" class="form-control" id="contact_phone2" name="contact_phone" style="width: 75%; margin-left: -5px; display: inline-block;">
                                                                </div>

                                                                <label id="country_code2-error" class="error" for="country_code2" generated="true"></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group" style="width: 100%;">
                                                                        <input type="text" value="<?php echo $fetch_add_contact_details['designation']; ?>" name="contact_designation" id="contact_designation" class="form-control text-area">
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group" style="width: 60%; display: inline-block !important">
                                                                        <input type="checkbox" name="contact_primary" id="contact_primary" value="1" <?php if ($fetch_add_contact_details['is_primary_contact'] == '1') { ?> checked="" <?php } ?> >
                                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <!--<button type="submit" class="create-event-form btn bg-blue2">Create Event</button>-->
                                                    <div class="input-group col-md-12" style="padding-right:15px">
                                                        <input type="button" value="Submit" class="submit btn green pull-right" name="module5_add_contact" id="module5_add_contact" >
                                                ...
                                                <form name="module1_send_msg" autocomplete="off" id="module1_send_msg" method="post" action="">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <div class="input-group col-md-12 pull-right" style="padding-left:10px">
                                                            <input type="button" value="Submit" class="submit btn green pull-left" name="<?php echo $fetch_details[0]['name']; ?>" id="sendtext_submit" val='<?php echo $fetch_details[0]['target_seq_no']; ?>' from_model="module5" admin_id="<?php echo $admin_id; ?>">
                                                            <div id="master_name_submit_loader" style="display:none; padding-left:10px;"><font color="green"><img src="<?php echo $base_url; ?>assets/img/FhHRx.gif"></font></div>
                                                        </div>
                                                    </div>
                                                </form>
...
//                      var url = "http://localhost/digital1crm/api/msg_push_notification"; //checking in local server
                    ...
                    $('#master_name_submit').on('click', function () {
                        var valid = $('#master_name_add_notes').valid();
                        if (valid) {
                    ...
                    $('#master_name_add_notes').validate({
                        rules: {
                            newnotes: {
                                required: true,
                                noSpace: true
                            ...
                            if (notes) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if (data == '1') {
                                            location.href = BASE_URL + 'competitor/product_purchase';
                                        }
                                    }
                                });
                            }
                    ...
                    $('#edit_details_btn').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: BASE_URL + 'competitor/edit_details_module5/',
                                data: {
                                    last_name: last_name,
                                    email: email,
                                ...
                                success: function (data) {
                                    ...
                                    if (data == 1) {
                                        jconfirm({
                                            ...
                                            buttons: {
                                                OK: function () {
                                                    window.location.href = BASE_URL + 'competitor/product_purchase/';
                                                }
                                            }
                                        });
                                    }
                    ...
                    $('#product_purchase_submit').on('click', function (e) {
                        var valid = $('#product_purchase_div').valid();
                        if (valid) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: BASE_URL + 'competitor/client_product_purchase/',
                                data: {
                                    product_purchased_date: product_purchased_date,
                                    product_purchase: 'Yes',
                                ...
                                beforeSend: function () {
                                    ...
                                    $('#product_purchase_submit').prop('disabled', true);

                                },
                                success: function (data) {
                                    $('#product_purchase_submit').prop('disabled', false);
                                    //$("#product_purchase_submit").ajaxloader('hide');
                                    if (data == 1) {
                                        //alert(data);
                                        jconfirm({
                                            title: 'Confirmation!',
                                            content: "Client has successfully purchased the product",
                                            buttons: {
                                                OK: function () {
                                                    window.location.href = BASE_URL + 'competitor/product_purchase';
                                                }
                    ...
                    $('#product_purchase_div').validate({
                        ...
                        messages: {
                            ...
                            product_purchase: {
                                required: "<font color=\"red\">You should check the box !</font>"
                            }
                        }
                    });

                    $('#module5_frmAddContact').validate({
                        rules: {
                            contact_first_name: {
                                required: true
                            },
                    ...
                    $('#module5_add_contact').on('click', function () {
                        var valid = $('#module5_frmAddContact').valid();
                        if (valid) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: BASE_URL + 'competitor/module5_add_contact/',
                                data: {
