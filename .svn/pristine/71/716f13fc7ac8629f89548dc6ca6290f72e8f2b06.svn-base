                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Activity View</span>
                                    </div>
                                    <div class="actions">
                                              ...
                                              <?php } ?>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         ...
                                                         <input type="hidden" name="origin_attorney_seq_no" value="<?php echo $att_firm[0]['attorney_seq_no']; ?>" disabled="disabled">
                                                         <span class="help-block"> </span>
                                                     </div>
                                                 </div>
                                                ...
                                                <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <input type="text" class="form-control" name="activity_name" placeholder="Enter text" value="<?php echo $this_activity['activity_goal']; ?>" disabled="disabled">
                                                         <span class="help-block"> </span>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <input type="text" value="<?php echo $this_activity['potential_revenue']; ?>" class="form-control" name="potential_revenue" placeholder="Enter text" value="0.00" readonly="readonly">
                                                         <span class="help-block"> </span>
                                                     </div>
                                                 </div>
                                                 <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-md-8">
                                                         <textarea class="form-control" style="height:80px;" name="remarks_notes" placeholder="Enter remarks/comments" disabled="disabled"><?php echo $this_activity['remarks_notes']; ?></textarea>
                                                         <span class="help-block">  </span>
                                                     </div>
                                                 </div>
<!-- 
                                                 <div class="margiv-top-10">
                                                     <button type="submit" name="add_new_activity_btn" id="add_new_activity_btn" class="btn green">Save</button>
                                                 </div> -->
...
<div id="individual_budget_dtl<?php echo ++$j; ?>" class="modal fade" tabindex="-1" aria-hidden="true">
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="ME01_hr" value="<?php echo $value['ME01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="ME01_bud" value="<?php echo $value['ME01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="ME02_hr" value="<?php echo $value['ME02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="ME02_bud" value="<?php echo $value['ME02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="ME03_hr" value="<?php echo $value['ME03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="ME03_bud" value="<?php echo $value['ME03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="ME04_hr" value="<?php echo $value['ME04']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="ME04_bud" value="<?php echo $value['ME04']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="ME05_hr" value="<?php echo $value['ME05']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="ME05_bud" value="<?php echo $value['ME05']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR01_hr" value="<?php echo $value['TR01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR01_bud" value="<?php echo $value['TR01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody> 
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR02_hr" value="<?php echo $value['TR02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR02_bud" value="<?php echo $value['TR02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR03_hr" value="<?php echo $value['TR03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR03_bud" value="<?php echo $value['TR03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR04_hr" value="<?php echo $value['TR04']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR04_bud" value="<?php echo $value['TR04']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR05_hr" value="<?php echo $value['TR05']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR05_bud" value="<?php echo $value['TR05']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="TR06_hr" value="<?php echo $value['TR06']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="TR06_bud" value="<?php echo $value['TR06']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CA01_hr" value="<?php echo $value['CA01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CA01_bud" value="<?php echo $value['CA01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CA02_hr" value="<?php echo $value['CA02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CA02_bud" value="<?php echo $value['CA02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CA03_hr" value="<?php echo $value['CA03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CA03_bud" value="<?php echo $value['CA03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC01_hr" value="<?php echo $value['CC01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC01_bud" value="<?php echo $value['CC01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC02_hr" value="<?php echo $value['CC02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC02_bud" value="<?php echo $value['CC02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC03_hr" value="<?php echo $value['CC03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC03_bud" value="<?php echo $value['CC03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC04_hr" value="<?php echo $value['CC04']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC04_bud" value="<?php echo $value['CC04']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC05_hr" value="<?php echo $value['CC05']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC05_bud" value="<?php echo $value['CC05']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC06_hr" value="<?php echo $value['CC06']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC06_bud" value="<?php echo $value['CC06']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="CC07_hr" value="<?php echo $value['CC07']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="CC07_bud" value="<?php echo $value['CC07']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB01_hr" value="<?php echo $value['IB01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB01_bud" value="<?php echo $value['IB01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB02_hr" value="<?php echo $value['IB02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB02_bud" value="<?php echo $value['IB02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB03_hr" value="<?php echo $value['IB03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB03_bud" value="<?php echo $value['IB03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB04_hr" value="<?php echo $value['IB04']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB04_bud" value="<?php echo $value['IB04']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB05_hr" value="<?php echo $value['IB05']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB05_bud" value="<?php echo $value['IB05']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB06_hr" value="<?php echo $value['IB06']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB06_bud" value="<?php echo $value['IB06']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB07_hr" value="<?php echo $value['IB07']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB07_bud" value="<?php echo $value['IB07']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB08_hr" value="<?php echo $value['IB08']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB08_bud" value="<?php echo $value['IB08']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB09_hr" value="<?php echo $value['IB09']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB09_bud" value="<?php echo $value['IB09']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB10_hr" value="<?php echo $value['IB10']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB10_bud" value="<?php echo $value['IB10']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB11_hr" value="<?php echo $value['IB11']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB11_bud" value="<?php echo $value['IB11']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="IB12_hr" value="<?php echo $value['IB12']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="IB12_bud" value="<?php echo $value['IB12']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="PS01_hr" value="<?php echo $value['PS01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="PS01_bud" value="<?php echo $value['PS01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="PS02_hr" value="<?php echo $value['PS02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="PS02_bud" value="<?php echo $value['PS02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="PS03_hr" value="<?php echo $value['PS03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="PS03_bud" value="<?php echo $value['PS03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="PS04_hr" value="<?php echo $value['PS04']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="PS04_bud" value="<?php echo $value['PS04']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="PS05_hr" value="<?php echo $value['PS05']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="PS05_bud" value="<?php echo $value['PS05']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="SC01_hr" value="<?php echo $value['SC01']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="SC01_bud" value="<?php echo $value['SC01']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="SC02_hr" value="<?php echo $value['SC02']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="SC02_bud" value="<?php echo $value['SC02']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
                                ...
                                <table width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:95%; height:30px; " type="text" class="form-control" name="SC03_hr" value="<?php echo $value['SC03']['budget_code_hours']; ?>" disabled="disabled">
                                                </div>

                                            </td>
                                            <td width="50%">
                                                <div class="form-group" style=" margin-bottom:0px">
                                                    <input style=" width:100%; height:30px; " type="text" class="form-control" name="SC03_bud" value="<?php echo $value['SC03']['budget_code_cost']; ?>" disabled="disabled">
                                                </div>
                                            </td>
