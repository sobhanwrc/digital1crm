			...
			<div class="add_activity_area">
				<div class="add_form_sec">
					<form role="form" id="add_new_activity_frm" method="post" action="<?php echo $base_url . 'activity/add' ?>" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							<h3 class="hint"> General Information <div style=" text-align:center; border-radius: 7px; width: 40px; height: 30px; background: #eee; line-height: 30px; display: inline-block; margin-left: 15px" id="menu" onclick="changec()"><i style=" font-size: 20px; margin-top: 5px" class="fa  fa-angle-double-down"></i></div>	</h3>
						</div>
						...
						<div class="col-md-12">
							...
							<div class="form-group required col-md-6" style="padding-left: 0; padding-right: 0">
							...
							<div class="form-group section required col-md-6" style="padding-left: 0; padding-right: 0;">
								...
								<div class="col-md-12">
									<select class="form-control" name="firm_section_seq_no" id="firm_section_seq_no">
										...
										<option value="<?php echo $value1['firm_section_seq_no']; ?>">
							...
							<div class="form-group strat_group required col-md-6" stpadding-left: 0; padding-right: 0;>
                                                            <label class="col-md-12 control-label" style=" padding-left: 0; padding-right: 0">Strategy Group:</label>
...
<?php } ?>
							...
							<div class="form-group required col-md-6" style="padding-left: 0; padding-right: 0; min-height: 80px;">
							...
							<div class="form-group new_act_goal required col-md-6" style="padding-left: 0; padding-right: 0;">
							...
							<div class="form-group existing_act_goal required col-md-6" style="padding-left: 0; padding-right: 0;">
								...
								<div class="col-md-12">
									<select class="form-control" name="existing_act_goal" id="existing_act_goal">
										...
										<option value="<?php echo $value['activity_goal']; ?>">
											<?php echo $value['activity_goal']; ?>
										</option>
										<?php } ?>
									</select>
									<span class="help-block">  </span>
...
<?php } ?>
							...
							<div class="form-group date date-picker required col-md-6" data-date-format="dd-M-yyyy">
								<label class="col-md-12 control-label">Activity Creation Date</label>
								<div class="col-md12">
									<input style=" width:88%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="activity_created_date" placeholder="DD-MMM-YYYY" value="<?php echo date('d-M-Y'); ?>">
											...
											<table width="100%" align="left">
												<tr>
													<td width="100%">
														<table width="100%">
															<tr>
																<td width="95%"><label class="control-label">From</label>
																</td>
															</tr>
															<tr>
																<td width="100%">
											...
											<table width="100%" align="left">
												<tr>
													<td width="100%">
														<table width="100%">
															<tr>
																<td width="100%"><label class="control-label">To</label>
																</td>
															</tr>
															<tr>
																<td width="100%">
																	<input style="width:77%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="duration_to" placeholder="DD-MMM-YYYY">
																	<span class="input-group-btn">
                                                                                                    <button class="btn default" type="button">
                                                                                                        <i class="fa fa-calendar"></i>
                                                                                                    </button>
							...
							<div class="form-group col-md-12" style="padding-left: 0; padding-right: 0">
								...
								<div class="col-md-12" style=" padding-left: 0">
									...
									<div id="show_hide">
										...
										<div class="form-group col-md-6" style="padding-left: 0; padding-right: 0;">
											<label class="col-md-12 control-label">Activity Details Status:</label>
											<div class="col-md-12">
...
<?php } ?>
										...
										<div class="form-group col-md-6" style="padding-left: 0; padding-right: 0;">
											<label class="col-md-12 control-label">Activity Budget Details Status:</label>
											<div class="col-md-12">
										...
										<div class="form-group col-md-6" style="padding-left: 0; padding-right: 0;">
											<label class="col-md-12 control-label">Relation Type:</label>
										...
										<div class="form-group col-md-6" style="display: none; padding-left: 0; padding-right: 0;" id="rel">
											<label class="col-md-12 control-label">Relation With:</label>
											<div class="col-md-12">
										...
										<div class="form-group col-md-6" style=" padding-left: 0; padding-right: 0;">
											...
											<div class="col-md-8">
												<a name="add_budget" id="add_budget" class="btn green pull-right" href="#responsive_budget" data-toggle="modal">Add Budget</a>
											</div>
										</div>
