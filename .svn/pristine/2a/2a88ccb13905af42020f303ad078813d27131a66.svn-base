            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                 ...
                 $(document).on('click','.a_preview', function(e){
                    $.ajax({
                        type: "POST",
                        url: BASE_URL + 'Client_referral/get_email_template/',
                        success:function(resp) {
                          var obj=$.parseJSON(resp);
                 ...
                 $(document).on('click','.a_file', function(e){
                   ...
                   $('#mailbuttons').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                               url: '<?php echo base_url(); ?>Client_referral/temp_sendmail',
                                data: {
                                    sub: $('#subject').val(),
                            ...
                            if (flag == 1) {
                                jconfirm({
                                    ...
                                    buttons: {
                                        OK: function () {
                                            window.location.href="<?php echo base_url();?>Client_referral";
                                        }
                                    }
                                });
                            }
