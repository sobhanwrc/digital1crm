                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Add Competitor</span>
                            </div>
                                                                <div class="actions">
                                                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                                                        <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active">
                                                                             <input type="radio" name="options" class="toggle" id="option1"><a style=" color:#fff; text-decoration: none;" href="javascript:void(0)" onclick="history.back()">Back</a></label>
<!--                                                                        <label class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                        ...
                        <div class="portlet-body">
                           ...
                           <div class="add_form_sec">
                               <form role="form" id="myfirm-general-info-form" autocomplete="off" method="post" action="<?php echo $base_url . 'competitor/add/' ?>">
                                       <div class="col-md-6">
                                         <div class="alert alert-success" id="general_msg_success" style="display:none">
                                         ...
                                         <div class="form-group required">
                                                  ...
                                                  <input type="text" placeholder="Enter Competitor ID" class="form-control" name="competitor_id" id="competitor_id" /> </div>
                                              <div class="form-group required">
                                                  <label class="control-label"> Competitor Code </label>
                                                  <input type="text" placeholder="Enter Competitor Code" class="form-control" name="competitor_code" id="competitor_code" /> </div>
                                              <div class="form-group required">
                                                  <label class="control-label">First Name</label>
                                                  <input type="text" placeholder="Enter First Name" class="form-control" name="first_name" id="first_name" /> </div>
                                              <div class="form-group required">
                                                  <label class="control-label">Last Name</label>
                                                  <input type="text" placeholder="Enter Last Name" class="form-control" name="last_name" id="last_name" /> </div>
                                              <div class="form-group required"> 
                                                  ...
                                                  <div class=" col-md-12" style=" padding-left: 0; padding-right: 0;">
                                                     ...
                                                     <select name="industry_type" id="industry_type" class="form-control">
                                                          <option value="">Select Industry</option>
                                                            ...
                                                            <?php foreach($ind_type as $key=>$value){ $value = (array) $value; ?>
                                                     ...
                                                     <input class="form-control placeholder-no-fix" type="text" placeholder="Enter Experience" name="experience" id="experience" /> </div>

                                                     <div class="input-group date date-picker req" data-date-format="dd-M-yyyy">
                                                      <label class="control-label">Bar Date </label>
                                                         <input aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="bar_date" id="bar_date" placeholder="dd-mm-yyyy" >
                                                     ...
                                                     <input class="form-control placeholder-no-fix" type="text" placeholder="Bar state" name="bar_state" id="bar_state"/> </div>
                                            ...
                                            <h3>Ranking</h3>
                                                <div class="form-group required">
                                                        ...
                                                        <select name="independent" id="independent" class="form-control">
                                                            ...
                                                            <?php foreach ($rank as $key1 => $value1) { ?>
