                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Registered User List</span>
                                    </div>
                                    <!--                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php $SlNo = 1;
                                            foreach ($reg_user_list as $key => $value) { ?>
                                                <tr>
                                                    <td> <?php echo $SlNo++;?> </td>
                                                    <td><?php echo $value['fname'].' '.$value['lname']; ?></td>
                                                    <td><?php echo $value['email']; ?></td>
                                                    <td> <?php echo ($value['address_line1']!= '' ? $value['address_line1']. ', ' : '')  . ($value['address_line2'] != '' ? $value['address_line2'] . '<br>' : '') . ($value['name']!= '' ? $value['name'] . ', ' : '') . ($value['state_name'] != '' ? $value['state_name'] . ', ' : '') . ($value['city_name'] != '' ? $value['city_name'] . ' - ' : '') . ($value['postal_code'] != '' ? $value['postal_code'] : '') ;?> </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li>
                                                                    <a  href="#responsive<?php echo $value['id']; ?>" data-toggle="modal">
                                                                        <i class="icon-tag"></i> View
                                                                    </a>
                                                                </li>
<!--                                                                <li>
                                                                    <a  href="#responsive_1_<?php echo $value['id']; ?>" data-toggle="modal">
            ...
            <?php foreach ($reg_user_list as $key => $value) { ?>
                <div id="responsive<?php echo $value['id']; ?>" class="modal fade" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title">View Register User</h4>
                            </div>
                            <form action="<?php echo $base_url; ?>register-users/edit/<?php echo $value['id']; ?>" name="reg_user_form" id="reg_user_form<?php echo $value['id']; ?>" method="post" class="reg_user_form_class">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text"  class="form-control" disabled="" value="<?php echo $value['fname'].' '.$value['lname']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" placeholder="Remarks or comments" name="remarks"><?php echo $value['remarks_notes']; ?></textarea>
                                                        <span class="help-block">  </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn green submit_btn_class" id="firmcodeadd-submit_btn<?php echo $value['firm_code_seq_no']; ?>">Save</button>-->
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <?php } ?>
 <?php foreach ($reg_user_list as $key => $value) { ?>
                <div id="responsive_1_<?php echo $value['id']; ?>" class="modal fade" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title">Update Register User</h4>
                            </div>
                            <form action="<?php echo $base_url; ?>register-user/edit/<?php echo $value['id']; ?>" name="reg_user_form" id="reg_user_form<?php echo $value['id']; ?>" method="post" class="reg_user_form_class">
                                <div class="modal-body">
                                    <div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <div class="modal-footer">
                                  <button type="button" data-dismiss="modal" class="btn dark btn-outline">Close</button>
                                    <button type="submit" class="btn green submit_btn_class" id="firmcodeadd-submit_btn<?php echo $value['id']; ?>">Save</button><!--  -->
                                </div>
                            </form>
                        </div>
                    </div>
