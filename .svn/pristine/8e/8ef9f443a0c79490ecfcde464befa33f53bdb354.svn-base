                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold">Activity:<?php echo " ".$this_activity['activity_name']; ?> </span><span class="caption-subject bold" style=" margin-left: 203px;"><?php echo "Goal:"." ".$this_activity['activity_goal']; ?></span><span class="caption-subject bold" style=" margin-left: 203px;"><?php echo "Origin Attorney:"." ".$att_firm[0]['attorney_first_name'] .' '. $att_firm[0]['attorney_last_name']; ?></span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                   ...
                                   <div style=" text-align: center; left: 15px; position: absolute; bottom:0; height: 20px; width: 97.1%; background: #eee; z-index: 9999"><button style=" outline: none; background-color:transparent; border-right: none; border-left: none;" id="clicker"><i style=" font-size: 30px;" class="fa fa-angle-down"></i></button></div>
                                        ...
                                        <?php $smsg = $this->session->flashdata('err_message'); if(isset($smsg) && $smsg != ''){ ?>
                                         ...
                                         <?php } ?>
                                            ...
                                            <div class="row" >
                                            	<div class="col-md-6">
                                            		<div class="portlet light col-md-12 bordered" style="display: inline-block">
														<div class="form-group required">
															...
															<div class="col-md-12">
																<!--<input type="text" name="" id="" class="form-control" value="<?php echo $att_firm[0]['firm_name']; ?>" disabled>-->
                                          			...
                                          			<div class="form-group required" style=" width: 100%; display: inline-block">
														<label class="col-md-12 control-label">Activity Goal:</label>
                                          			...
                                          			<div class="form-group new_act_goal required">
														...
														<div class="form-group required">
															...
															<div class="col-md-12">
																<textarea class="form-control" style="height:105px;" name="activity_reason_desc" placeholder="Enter Activity Reason">
																	<?php echo $this_activity['activity_reason_desc']; ?>
																</textarea>
																<span class="help-block">  </span>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-12">
																<textarea class="form-control" style="height:105px;" name="remarks_notes" placeholder="Enter remarks/comments">
																	<?php echo $this_activity['remarks_notes']; ?>
																</textarea>
																<span class="help-block">  </span>
															</div>
														</div>
                                            	...
                                            	<div class="col-md-6">
                                            		<div class="portlet col-md-12 light bordered" style=" display: inline-block">
														<div class="form-group required">
															<!--<label class="col-md-12 control-label">Origin Attorney:</label>-->
															<div class="col-md-12">
																<!--<input type="text" name="" id="" class="form-control" value="<?php echo $att_firm[0]['attorney_first_name'] .' '. $att_firm[0]['attorney_last_name']; ?>" disabled>-->
                                            ...
                                            <div class="form-group">
                                               ...
                                               <div class="form-group" style=" width:100%; display:inline-block">
                                                  ...
                                                  <table width="100%">
                                                  	<tr>
                                                    	<td width="50%">
                                                        <input style="margin-left: -8px; margin-top: -11px;" type="radio" name="relation_type" id="rel_type1" class="form-control" value="T" onchange="get_rel('T')" <?php //if($act_dtl_res[0]['relation_type'] == 'T'){ echo 'checked="checked"'; } ?>> Target 
                                                        </td>
                                                        <td width="50%">
                                                        	<input style="margin-left: -8px; margin-top: -11px;" type="radio" name="relation_type" id="rel_type2" class="form-control" value="C" onchange="get_rel('C')" <?php //if($act_dtl_res[0]['relation_type'] == 'C'){ echo 'checked="checked"'; } ?>> Client
                                                        </td>
                                                    </tr>
                                                  </table>
                                             ...
                                             <div class="form-group" style="width:100%;" style="display: none;" id="rel">
...
//            alert(123);
//              $('#show_hide').hide();
            <?php  if($this_activity['activity_type'] == 'INDIVIDUAL') { ?>
                $('#show_hide').show();
