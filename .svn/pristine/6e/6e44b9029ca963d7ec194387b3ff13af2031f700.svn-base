                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Attorney Goal Edit</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active">
                                                <input type="radio" name="options" class="toggle" id="option1"><a style=" text-decoration: none; color:#fff" href="" onclick="history.back()"> Back</a></label>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form autocomplete="off" name="app_codes_form" id="app_codes_form" action="<?php echo $base_url; ?>app_codes/add" method="post">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label class="col-md-4 control-label">Firm</label>
                                                                    <div class="col-md-8">
                                                                        <input type="text" class="form-control " placeholder="Enter text" value="<?php echo $att_goal[0]['firm_name']; ?>" disabled="disabled">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <input type="text" class="form-control " placeholder="Enter text" value="<?php echo $att_goal[0]['attorney_first_name'] .' '. $att_goal[0]['attorney_last_name']; ?>" disabled="disabled">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="<?php echo $att_goal[0]['current_year']; ?>" disabled="disabled" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="<?php echo $att_goal[0]['current_year_goal'] ; ?>" disabled="disabled" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-md-4 control-label">Current Year Goal%</label>
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="<?php echo $att_goal[0]['current_year_goal_percentage']; ?>" disabled="disabled" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="<?php echo $att_goal[0]['summary_info']; ?>" disabled="disabled" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <textarea class="form-control" name="remarks" placeholder="Enter text" disabled="disabled"><?php echo $att_goal[0]['remarks_notes'] ; ?> </textarea>
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <!-- <div class="form-group rightPanel">
                                            ...
                                            <div class="col-md-9" style=" padding-left: 0">
                                                <div class="btn-group pull-right">
                                                    <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" >
                                                        <button class="btn sbold green"> Add New or Link Old Client
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Add New or Link Old Client</h4>
                                                </div>
                                                <form  name="link_client_form" id="link_client_form" action="<?php echo $base_url;?>attorney-goals/link_client" method="post">  
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select class="form-control"  name="group_code">
                                                                                ...
                                                                                foreach ($client as $key => $value) {
                                                                                    ?>
                                                                                    <option value="<?php echo $value['client_seq_no']; ?>"><?php echo $value['client_first_name'] . ' ' . $value['client_last_name']; ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                            <span class="help-block"> </span>
                                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Previous FY:</label>
                                                <div class="col-md-8">
                                                    <input type="text"  name="pre_fy" class="form-control" placeholder="Enter text" id="pre_fy">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                           <div class="form-group">
                                                <label class="col-md-4 control-label">Previous FY Goal %:</label>
                                                <div class="col-md-8">
                                                    <input type="text"  name="pre_fy_goal" class="form-control" placeholder="Enter text" id="pre_fy_goal">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Past FY Goal in US$:</label>
                                                <div class="col-md-8">
                                                    <input type="text"  name="goal" class="form-control" placeholder="Enter text" id="goal">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                                                    <div class="form-group">
