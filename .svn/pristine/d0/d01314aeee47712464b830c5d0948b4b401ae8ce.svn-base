                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Module 9</span>
                            </div>
                            <!--                                    <div class="actions">
...
//                                    t($value); exit;
                                    ?>
                                    <tr style=" cursor: pointer" onclick="javascript:window.location.href='<?php echo $base_url; ?>Client_referral/view/<?php echo base64_encode($value['target_seq_no']); ?>/<?php  echo base64_encode($value['id'])  ;?>'">

                                        <td><?php echo $SlNo++ ?></td>
                                        <?php if($value['type']=='I') { ?>
                                        <td class="border_show"><?php echo  $value['name'];
                                        ?></td>
                                        <?php 
                                           } 
                                           else
                                        ...
                                        ?></td>
                                           <?php } ?>
                                        <?php if($value['type']=='C') { ?>
                                        <td class="border_show"><?php echo  $value['company_name']; ?>
                                         </td>
                                         <?php 
                                           } 
                                           else
                                            { 
                                            ?><td><?php echo  $value['company_name']; ?></td><?php } ?>
...
<!--<link rel="stylesheet" type="text/css" href="<?php echo $assets_path; ?>layouts/layout/css/layout.min.css">-->
