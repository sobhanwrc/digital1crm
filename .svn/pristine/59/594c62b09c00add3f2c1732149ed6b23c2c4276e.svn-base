                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" placeholder="First Name" class="form-control"  name="firstname" id="firstname" value="<?php if(isset($attorney[0])) {echo $attorney[0]['attorney_first_name'];}  ?>" disabled=''/>
                                                                </div> 
                                                                <div class="form-group required">
                                                                    <label class="control-label">Last Name</label>
                                                                    <input type="text" placeholder="Last Name" class="form-control"  name="lastname" id="lastname"  value="<?php if(isset($attorney[0]['attorney_last_name'])) {echo $attorney[0]['attorney_last_name'];}  ?>" disabled=''/>
                                                                </div>
                                                                <div class="form-group required">
                                                                    <label class="control-label">Email</label>
                                                                    <input type="text" placeholder="Email" class="form-control"  name="email" id="email" value="<?php if(isset($attorney[0]['attorney_email1'])) {echo $attorney[0]['attorney_email1'];}  ?>" disabled=''/>
                                                                </div>
                                                                
<!--                                                                 <div class="form-group required">
                                                                    <label class="control-label">Password</label>
                                                                    <input type="password" placeholder="Password" class="form-control"  name="password" id="password" value="<?php if(isset($attorney[0]['password'])) {echo $attorney[0]['password'];}  ?>" disabled=''/>
                                                                </div>-->
                                                             
<!--                                                                <div class="form-group required">
                                                                    <label class="control-label">Mobile</label>
                                                                    <input type="text" placeholder="Mobile" class="form-control"  name="mobile" id="mobile" value="<?php if(isset($attorney[0]['mobile'])) {echo $attorney[0]['mobile'];}  ?>" disabled=''/>
                                                                </div>
                                                            
                                                                <div class="form-group required">
                                                                    <label class="control-label">Phone1</label>
                                                                    <input type="text" placeholder="Phone1" class="form-control"  name="phone1" id="phone1" value="<?php if(isset($attorney[0]['phone1'])) {echo $attorney[0]['phone1'];}  ?>" disabled=''/>
                                                                </div>
                                                                <div class="form-group required">
                                                                    <label class="control-label">Phone2</label>
                                                                    <input type="text" placeholder="Phone2" class="form-control"  name="phone2" id="phone2" value="<?php if(isset($attorney[0]['phone2'])) {echo $attorney[0]['phone2'];}  ?>" disabled=''/>
                                                                </div>-->
                                                                <div class="form-group required">
                                                                    <label class="control-label" style=" width: 100%; display: inline-block">Mobile</label>
                                                                    <input readonly type="text" value="<?php echo $country_code_3; ?>" placeholder="" class="form-control" id="country_code3" name="country_code3" autocomplete="off" style="width: 15%; display: inline-block">
                                                                    <input readonly type="text" placeholder="Mobile" class="form-control"  name="mobile" id="mobile" value="<?php echo $mobile;  ?>" style="width: 85%; margin-left: -5px; display: inline-block"/>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" value="<?php echo $country_code_1; ?>" placeholder="" class="form-control" id="country_code1" name="country_code1" autocomplete="off" style="width: 15%; display: inline-block">
                                                                    <input readonly type="text" placeholder="Phone1" class="form-control"  name="phone1" id="phone1" value="<?php echo $phone_1; ?>" style="width: 85%; margin-left: -5px; display: inline-block"/>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" value="<?php echo $country_code_2; ?>" placeholder="" class="form-control" id="country_code2" name="country_code2" autocomplete="off" style="width: 15%; display: inline-block">
                                                                    <input readonly type="text" placeholder="Phone2" class="form-control"  name="phone2" id="phone2" value="<?php echo $phone_2;  ?>" style="width: 85%; margin-left: -5px; display: inline-block" />
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" placeholder="Position" class="form-control"  name="position" id="position" value="<?php if(isset($attorney[0]['position'])) {echo $attorney[0]['position'];}  ?>" disabled=''/>
                                                                </div>
                                                                <div class="form-group required">
