...
class PHPExcel_Calculation {
	...
	public static $returnArrayAsType	= self::RETURN_ARRAY_AS_VALUE;
	 ...
	 * @var array
	 */
	public $_calculationCache = array ();
	 ...
	 * @var boolean
	 */
	public $_calculationCacheEnabled = TRUE;
	 ...
	 * @var array
	 */
	public static $_operators			= array('+' => TRUE,	'-' => TRUE,	'*' => TRUE,	'/' => TRUE,
	 ...
	 * @var array
	 */
	public static $_binaryOperators	= array('+' => TRUE,	'-' => TRUE,	'*' => TRUE,	'/' => TRUE,
												'^' => TRUE,	'&' => TRUE,	'>' => TRUE,	'<' => TRUE,
												'=' => TRUE,	'>=' => TRUE,	'<=' => TRUE,	'<>' => TRUE,
												'|' => TRUE,	':' => TRUE
											   );
	 ...
	 *
	 */
	public $_cyclicFormulaCount = 0;

	public $_cyclicFormulaCell = '';
	 ...
	 *
	 */
	public static $_localeLanguage = 'en_us';					//	US English	(default locale)
	 ...
	 *
	 */
	public static $_validLocaleLanguages = array(	'en'		//	English		(default language)
												 );
	/**
	 ...
	 *
	 */
	public static $_localeArgumentSeparator = ',';
	public static $_localeFunctions = array();
	 ...
	 *
	 */
	public static $_ExcelConstants = array('TRUE'	=> TRUE,
											'FALSE'	=> FALSE,
											'NULL'	=> NULL
										   );

	//	PHPExcel functions
	public static $_PHPExcelFunctions = array(	// PHPExcel functions
	...
	public static $_controlFunctions = array(
	...
	public static function _loadLocales() {
	...
	public static function _translateFormula($from,$to,$formula,$fromSeparator,$toSeparator) {
	...
	public static $functionReplaceFromExcel	= NULL;
	public static $functionReplaceToLocale		= NULL;
	...
	public static $functionReplaceFromLocale	= NULL;
	public static $functionReplaceToExcel		= NULL;
...
//echo 'Retrieve from cache',PHP_EOL;
	 ...
	 *											2 = extend to fit
	 */
	public static function _checkMatrixOperands(&$operand1,&$operand2,$resize = 1) {
	 ...
	 */
	public static function _resizeMatricesShrink(&$matrix1,&$matrix2,$matrix1Rows,$matrix1Columns,$matrix2Rows,$matrix2Columns) {
	 ...
	 * @param	integer		$matrix2Columns	Column size of second matrix operand
	 */
	public static function _resizeMatricesExtend(&$matrix1,&$matrix2,$matrix1Rows,$matrix1Columns,$matrix2Rows,$matrix2Columns) {
		if (($matrix2Columns < $matrix1Columns) || ($matrix2Rows < $matrix1Rows)) {
			if ($matrix2Columns < $matrix1Columns) {
				for ($i = 0; $i < $matrix2Rows; ++$i) {
	 ...
	 * @return	mixed
	 */
	public function _showValue($value) {
	 ...
	 * @return	mixed
	 */
	public function _showTypeDetails($value) {
		if ($this->_debugLog->getWriteDebugLog()) {
			$testArray = PHPExcel_Calculation_Functions::flattenArray($value);
			if (count($testArray) == 1) {
				$value = array_pop($testArray);
	...
	public static function _convertMatrixReferences($formula) {
	...
	public static function _mkMatrix() {
	...
	public static $_operatorAssociativity	= array(
		'^' => 0,															//	Exponentiation
	...
	public static $_comparisonOperators	= array('>' => TRUE, '<' => TRUE, '=' => TRUE, '>=' => TRUE, '<=' => TRUE, '<>' => TRUE);

	//	Operator Precedence
	//	This list includes all valid operators, whether binary (including boolean) or unary (such as %)
	//	Array key is the operator, the value is its precedence
	public static $_operatorPrecedence	= array(
		':' => 8,																//	Range
		'|' => 7,																//	Intersect
		'~' => 6,																//	Negation
		'%' => 5,																//	Percentage
	...
	public function _parseFormula($formula, PHPExcel_Cell $pCell = NULL) {
...
//					echo 'Element is an Intersect Operator<br />';
	...
	public static function _dataTestReference(&$operandData)
	{
	...
	public function _processTokenStack($tokens, $cellID = NULL, PHPExcel_Cell $pCell = NULL) {
...
//		}
	...
	public function _validateBinaryOperand($cellID, &$operand, &$stack) {
		if (is_array($operand)) {
	...
	public function _executeBinaryComparisonOperation($cellID, $operand1, $operand2, $operation, &$stack, $recursingArrays=FALSE) {
	 ...
	 * @return integer
	 */
	public function strcmpLowercaseFirst($str1, $str2)
	{
	...
	public function _executeNumericBinaryOperation($cellID,$operand1,$operand2,$operation,$matrixFunction,&$stack) {
