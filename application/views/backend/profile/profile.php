                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet ">
                                    ...
                                    <div class="profile-userpic">
                                        <img src="<?php echo $assets_path; ?>pages/media/profile/profile_user.jpg" class="img-responsive" alt=""> </div>
                                    <!-- END SIDEBAR USERPIC -->
                                    <!-- SIDEBAR USER TITLE -->
                                    ...
                                    <div class="profile-usermenu">
                                        <ul class="nav">
                                            <li class="active">
                                                <a href="http://dev.wrctechnologies.com/ams/lawyer_profile/index">
                                                    <i class="icon-home"></i> Overview </a>
                                            </li>
                                            <li>
                                                <a href="http://dev.wrctechnologies.com/ams/lawyer_profile/account">
                                                    <i class="icon-settings"></i> Account Settings </a>
                                            </li>
                                            <li>
                                                <a href="http://dev.wrctechnologies.com/ams/lawyer_profile/help">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="table-scrollable table-scrollable-borderless">
                                                    <table class="table table-hover table-light">
                                                        ...
                                                        <tr>
                                                            <td class="fit">
                                                                <img class="user-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar4.jpg"> </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="fit">
                                                                <img class="user-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar5.jpg"> </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="fit">
                                                                <img class="user-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar6.jpg"> </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="fit">
                                                                <img class="user-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar7.jpg"> </td>
                                                            <td>
                                                ...
                                                <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                                                    <div class="general-item-list">
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar4.jpg">
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar3.jpg">
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar6.jpg">
                                                                    <a href="" class="item-name primary-link">Nick Larson</a>
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar7.jpg">
                                                                    <a href="" class="item-name primary-link">Nick Larson</a>
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar9.jpg">
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar8.jpg">
                                                        ...
                                                        <div class="item">
                                                            <div class="item-head">
                                                                <div class="item-details">
                                                                    <img class="item-pic" src="<?php echo $assets_path; ?>pages/media/users/avatar2.jpg">
                                                ...
                                                <div class="timeline">
                                                    ...
                                                    <div class="timeline-item">
                                                        <div class="timeline-badge">
                                                            <img class="timeline-badge-userpic" src="<?php echo $assets_path; ?>pages/media/users/avatar80_2.jpg"> </div>
                                                    ...
                                                    <div class="timeline-item">
                                                        <div class="timeline-badge">
                                                            <img class="timeline-badge-userpic" src="<?php echo $assets_path; ?>pages/media/users/avatar80_7.jpg"> </div>
                                                        <div class="timeline-body">
                                                            <div class="timeline-body-arrow"> </div>
                                                            <div class="timeline-body-head">
                                                                <div class="timeline-body-head-caption">
