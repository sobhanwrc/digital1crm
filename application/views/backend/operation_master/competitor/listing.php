                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Module 3</span>
                            </div>
                            <!--                                    <div class="actions">
...
-->
                            ...
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    //t($value); exit;
                                    ?>
                                    <tr style=" cursor: pointer" onclick="javascript:window.location.href='<?php echo $base_url; ?>competitor/view/<?php echo base64_encode($value['target_seq_no']); ?>/<?php echo base64_encode($value['firm_seq_no']); ?>/<?php  echo base64_encode($value['id']);?>'">

                                        <td><?php echo $SlNo++ ?></td>
                                        <td <?php if($value['type']=='I') { ?> class="border_show" <?php } ?>><?php echo  ucwords($value['first_name'].' '. $value['last_name']); ?>
                                        </td>
                                        <td <?php if($value['type']=='C') { ?> class="border_show" <?php } ?>><?php echo $value['company_name'];?></td>
                                        <td><?php echo $value['phione']; ?></td>
