            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                 ...
                 $(document).on('click','.a_preview', function(e){
                    $.ajax({
                        type: "POST",
                        url: BASE_URL + 'competitor/get_email_template5/',
                        success:function(resp) {
                          var obj=$.parseJSON(resp);
                    ...
                    $('#update_document_submit').on('click', function (e) {
                     ...
                     $('#mailbuttons').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                               url: '<?php echo base_url(); ?>competitor/temp_sendmail5',
                                data: {
                                    sub: $('#subject').val(),
                            ...
                            if (flag == 1) {
                                jconfirm({
                                    ...
                                    buttons: {
                                        OK: function () {
                                            window.location.href="<?php echo base_url();?>competitor/product_purchase";
                                        }
                                    }
                                });
                            }
