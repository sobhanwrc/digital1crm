                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <form role="form" id="industry-type-general-info-edit-form" enctype="multipart/form-data" autocomplete="off" method="post" action="<?php echo $base_url . 'Industry_Type/update' ?>" novalidate="novalidate">
                                              <input type="hidden" name="industry_type_seq_no" id="industry_type_seq_no" value="<?php echo base64_encode($industry_type_details[0]['industry_type_seq_no']);?>" />
                                                <div class="row">
...
//                                                            t($city_info);exit;
                                                            ...
                                                            <div class="form-group required">
                                                                ...
                                                                <input type="text" placeholder="Enter Type Name" class="form-control" name="type_name" id="type_name" autocomplete="off" value="<?php echo $industry_type_details[0]['type_name']; ?>" />
                                                            </div>
                                                            <div class="form-group required">
                                                                    <label class="control-label">Status</label>
                                                                    <select name="status" id="status" class="form-control">
                                                                    <option value="1" <?php echo $industry_type_details[0]['status'] == "1" ? 'selected':'' ;?>>Active</option>
                                                                    <option value="0" <?php echo $industry_type_details[0]['status'] == "0" ? 'selected':'' ;?>>De-Active</option>
                                                                    </select>
                                                            </div>
