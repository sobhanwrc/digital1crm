                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        <div class="add_form_sec">
                                            <form role="form" autocomplete="off" id="add_new_wmployee_frm" method="post" action="#" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div style=" width: 18%; display: inline-block;"><input type="text" value="" placeholder="" class="form-control" id="digital1_staff_country_code" name="digital1_staff_country_code" autocomplete="off"></div>

                                                            <div style="margin-left: -10px; width: 83%; display: inline-block;"><input class="form-control placeholder-no-fix" type="text" placeholder="Phone1" name="phone1_appointment_user" id="phone1_appointment_user"  /> </div>  
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="date_of_appointment_user" id="date_of_appointment_user" placeholder="DD-MM-YYYY" >
...
//                    $("#loader_image").hide();
            ...
            jQuery('#digital1_staff_country_code').keyup(function() {
