                                                            ...
                                                            <div class="row mb5 mt10">
                                                                ...
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control mentions" id="narrative_type" name="narrative_type" style="width:400px"  value="" required="">
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <input type="button" id="mailbuttons1" name="mailbutton1" value="Save" class="btn btn-primary">
...
//                    $("#loader_image").hide();
                ...
                $('#mailbuttons1').on('click', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: b + 'emailtemplate/add_emailtemplate/',
                        data: {template_name: template_name, msg: msg},
                        success: function(response) {

                            location.href = BASE_URL + 'emailtemplate/';
