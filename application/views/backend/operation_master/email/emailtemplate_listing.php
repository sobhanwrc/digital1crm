                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo $base_url; ?>emailtemplate">Email Template</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>List</span>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Email List</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <a href="<?php echo $base_url; ?>emailtemplate/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <?php if ($role_code == 'FIRMADM') { ?>
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>emailtemplate/edit/<?php echo base64_encode($val['id']); ?>">
                                                                            <i class="icon-docs"></i> Edit </a>
                                                                    </li>
                                                                
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>emailtemplate/delete/<?php echo base64_encode($val['id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
