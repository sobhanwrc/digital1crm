                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Meeting/Appointment</span>
                            </div>
                            <!--                                    <div class="actions">
                            ...
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6" style=" padding-left: 0">
                                        <div class="btn-group">
                                            <a href="<?php echo $base_url; ?>Meeting_Appointment/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $base_url . 'Meeting_Appointment/details/' . base64_encode($value['meeting_seq_no']); ?>">
                                                            <i class="icon-docs"></i> View </a>
                                                    </li>
                                                    
                                                   
                                                  <li>
                                                        <a href="<?php echo $base_url . 'Meeting_Appointment/delete/' . base64_encode($value['meeting_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
...
<!--                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $base_url . 'Meeting_Appointment/edit/'. base64_encode($value['meeting_seq_no']); ?>">
