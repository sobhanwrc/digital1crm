            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                 ...
                 $(document).on('click','.a_preview', function(e){
                    $.ajax({
                        type: "POST",
                        url: BASE_URL + 'Targets/get_email_template/',
                        success:function(resp) {
                          var obj=$.parseJSON(resp);
                    ...
                    if($(this).is(':checked')) {
                     ...
                     $('#mailbuttons').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                                url: '<?php echo base_url(); ?>targets/temp_sendmail',
                                data: {
                                    sub: $('#subject').val(),
                            ...
                            if (flag == 1) {
                                jconfirm({
                                    title: 'Confirmation!',
                                    content: 'Email sent successfully.Please click on next module to continue.',
                                    buttons: {
                                        OK: function () {
