                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Manage Firm Contacts</span>
                            </li>
                        </ul>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Manage Firm Contacts  List</span>
                                    </div>
                                    <!--                                    <div class="actions">
                                    ...
                                    <?php
                                    //$smsg = $this->session->flashdata('suc_message');
                                    //if (isset($smsg) && $smsg != '') {
                                    ?>
                                    ...
                                    <div style="width: 100%; position: relative; padding-left: 0%; top:6px;">
                                        <?php if ($role_code == 'SITEADM' || $role_code == 'FIRMADM') { ?>
                                                   ...
                                                   <div class="col-md-6" style=" padding-left: 0">
                                                       <div class="btn-group">
                                                           <a href="<?php echo $base_url; ?>attorney/add" class="btn btn-outline sbold"  >  <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > 
                                                               <button class="btn sbold green"> Request for Contact
                                            ...
                                            <span style="  margin-bottom: 10px; text-align: right; display: inline-block">
                                                ...
                                                <?php // if ($cat_count == '1') {?>
                                                <?php if (($cat_details[0]['status'] == '2') || ($cat_details[0]['status'] == '')) { ?>            
                                                    <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="modal" data-target="#add_category" id="add_category1">Request For Contact</button>
                                                <?php } elseif (($cat_details[0]['status'] == '0')) {
                                                    ?>
                                                    <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="modal" data-target="" id="">Pending for Approval</button>
                                                <?php } else {
                                                    ?>
                                                    <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="modal" data-id="<?php echo $cat_details[0]['id']; ?>" data-industry-id="<?php echo $cat_details[0]['industry_type_seq_no']; ?>" data-target="" id="download_contact">Download Contact</button>
                                                <?php } ?>
                                            </span>
                                        <?php } ?>

                                        <span style="  margin-bottom: 10px; text-align: right; display: inline-block">
                                            <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="modal" data-id="" data-industry-id="" data-target="#import_contact" id="">Import Contact</button>
                                        </span>
                                            
                                        <!-- <span style="  margin-bottom: 10px; text-align: right; display: inline-block">
                                            <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="" data-id="" data-industry-id="" data-target="" id="send_invite">Send</button>
                                        </span>   
                                        
                                        <span style="  margin-bottom: 10px; text-align: right; display: inline-block">
                                            <button type="button" class="btn btn-transparent dark btn-outline btn-circle active" data-toggle="modal" data-id="" data-industry-id="" data-target="#appointment_date_and_time_div" id="">Add Contact</button>
                                        </span>    -->
                                    </div>
