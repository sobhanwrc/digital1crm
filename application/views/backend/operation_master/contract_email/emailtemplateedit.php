                                                ...
                                                <div class="tab-pane active p15" id="email-compose">
                                                    ...
                                                    <div class="email-compose">
                                                      ...
                                                      ?>
                                                        ...
                                                        <?php  } ?>
                                                       <form  method="post" name="frm1" id="profile_naratives">
                                                        <div class="row mb5 mt10">

                                                            <div class="col-xs-12">

                                                                <div class="form-group" style="display: inline-block;height: auto;margin-bottom: 15px;width: 100%;">
                                                                ...
                                                                <input style="margin-top: 21px;" type="button" id="mailbuttons1" name="mailbutton1" value="Update" class="btn btn-primary">
