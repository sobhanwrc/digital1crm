                ...
                <div class="page-content">
                    ...
                    <div class="page-bar" style=" position: relative">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>client_master">Module2</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>View</span>
                                ...
                                <td style=" width: 90px">
                                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                                        ...
                                        <!--<input name="options" class="toggle" id="option1" type="radio">-->
                                            <a style=" text-decoration: none; color:#fff" href="" onclick="javascript:window.location.href = '<?php echo $base_url; ?>client_master'"> Back to Listing</a></label>
                                    </div>
                                </td>
...
<?php if ($targets[0]['type'] == "C") { ?>
                                                    <span style=" font-size: 20px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;"><?php echo $targets[0]['company_name'] ?>,</span>

                                                    <span style=" width: auto; padding: 0 5px; font-weight: bold; display: inline-block;">
                                                        <div>
    <?php echo $targets[0]['first_name'] . ' ' . $targets[0]['last_name']; ?>
                                                        </div>


                                                    </span>
<?php } else { ?>
                                                    <span style=" font-size: 16px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;"><?php echo $targets[0]['first_name'] . ' ' . $targets[0]['last_name']; ?>,</span>

                                                    <span style=" width: auto; padding: 0 5px; font-weight: bold; display: inline-block;">
                                                        <div>
    <?php echo $targets[0]['company_name']; ?>
                                                        </div>
...
<?php } ?>
                                                ...
                                                <span style=" width: auto; padding: 0 5px; display: inline-block;">
                                                    ...
                                                    <a class="call_now" href="javascript:void(0)" val='<?php echo $targets[0]['target_seq_no']; ?>' from_model="module2" name="<?php echo $targets[0]['first_name'] . ' ' . $targets[0]['last_name']; ?>"><i style="font-size: 23px; margin-left: 10px; color:#337ab7" class="fa fa-phone-square"></i></a>
    ...
    <?php } else { ?>
                                                    <div style="width: 100%; display: inline-block;">
                                                        ...
                                                        <span style=" font-size: 20px; font-weight: bold; width: auto; padding: 0 5px; display: inline-block;">
                                                            ...
                                                            <div><?php echo $targets[0]['first_name'] . ' ' . $targets[0]['last_name']; ?></div>

                                                        </span>
                                                        <span style=" width: auto; padding: 0 5px; display: inline-block;"><strong>Email: </strong><?php echo $targets[0]['email']; ?></span>

                                                        <span style=" width: auto; padding: 0 5px; display: inline-block;">
                                                            <div class="caption-subject bold" style=" width: 100%; display: inline-block;">Phone: <?php echo $targets[0]['phione']; ?>
                                                                <a href=""><i style="font-size: 23px; margin-left: 10px; color:#337ab7" class="fa fa-phone-square"></i></a>
                                                            </div>
                                    ...
                                    <div class="main_hidediv_area">
                                        ...
                                        <div style=" width: 100%; display: inline-block; height: 50px;">
                                            <?php if ($fetch_module_details[0]['content'] != '') { ?>
                                                <span style="font-weight: 700; vertical-align: top;" class="span-width"><?php echo $fetch_module_details[0]['content']; ?></span>
<?php } ?> <button class="btn btn-transparent dark btn-outline btn-circle active1" data-target="#appointment_date_and_time_div" data-toggle="modal" >
                                                <img src="<?php echo $assets_path; ?>pages/img/Make_Appointment.png" alt="" class="menu_icon" />
                                                Make Appointment
                                            </button> 
                                            ...
                                            <div class="col-md-4" style=" padding-right: 0">
                                                ...
                                                <div class="comm_section">
                                                    <ul class="list-inline pull-right">
                                                        ...
                                                        <li><a href="<?php echo $base_url; ?>client_master/temp_email/<?php echo base64_encode($target_seq_nos); ?>/<?php echo base64_encode($company_ids); ?>"><i class="fa fa-envelope-o"></i>Email</a>
                                                        </li>
                                                        <li>
                                                ...
                                                <div class="portlet light bordered">
                                                    <div class="next_date_area">
                                                        <ul class="list-unstyled">
                                                            <li><button class="btn btn-transparent dark btn-outline btn-circle active" data-target="#next_call_date_and_time_div" data-toggle="modal" >
                                                                    <img src="<?php echo $assets_path; ?>pages/img/Next_Call_Date.png" alt="" class="menu_icon" />
                                                                    Next Call Date
                                                                </button>
                                                            </li>
                                                            <!--  <li><button class="btn btn-transparent dark btn-outline btn-circle active1" data-target="#appointment_date_and_time_div" data-toggle="modal" >
                                                              <img src="<?php echo $assets_path; ?>pages/img/Make_Appointment.png" alt="" class="menu_icon" />
                                                              Make Appointment
                                                              </button>
                                                              </li> -->

                                                            <li><button class="btn btn-transparent dark btn-outline btn-circle active" id="" data-target="#module2_addContactModal" data-toggle="modal" >
