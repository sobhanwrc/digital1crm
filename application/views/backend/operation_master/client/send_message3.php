                ...
                $(document).ready(function () {
                    ...
                    $('#upload-btn').click(function(e){
                        ...
                        var fileToUpload = inputFile[0].files[0];
                         //alert(console.log(fileToUpload));
                 ...
                 $(document).on('click','.a_preview', function(e){
                    $.ajax({
                        type: "POST",
                        url: BASE_URL + 'client_master/get_email_template/',
                        success:function(resp) {
                          var obj=$.parseJSON(resp);
                    ...
                    $('#update_document_submit').on('click', function (e) {
                     ...
                     $('#mailbuttons').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                               url: '<?php echo base_url(); ?>client_master/temp_sendmail',
                                data: {
                                    sub: $('#subject').val(),
                           ...
                           if (flag == 1) {
                                jconfirm({
                                    ...
                                    buttons: {
                                        OK: function () {
                                            window.location.href="<?php echo base_url();?>client_master";
                                        }
                                    }
                                });
                            }
