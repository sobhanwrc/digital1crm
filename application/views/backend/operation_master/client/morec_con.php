                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Add Contact</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                               <div class="row">
                                    <div class="add_form_sec">
                                        <form role="form" id="add_new_cli_contact" autocomplete="off" method="post" action="<?php echo $base_url . 'client-master/insert_cont' ?>" enctype="multipart/form-data">
