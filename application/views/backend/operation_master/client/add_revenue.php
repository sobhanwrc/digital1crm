                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Add Revenue</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class="add_form_sec">
                                            <form role="form" id="add_new_cli_rev_frm1" autocomplete="off" method="post" action="<?php echo $base_url . 'client-master/addPreviousRevenue/' . base64_encode($id); ?>" enctype="multipart/form-data">

                                                <div class="col-md-12">
                                                    <?php
                                                    $smsg = $this->session->flashdata('err_message');
                                                    if (isset($smsg) && $smsg != '') {
                                                        ?>
                                                    ...
                                                    <?php } ?>
                                                    <h3 class="hint">Revenue Details </h3>
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Financial Year</label>
                                                        <select name="year[]" class="form-control" <?php if($readonly){ echo $readonly; } ?>>
                                                            <option value="2014">2014</option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Goal Percentage</label>
                                                        <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[0]['fy_goal_percentage_of_last_fy']; ?>" placeholder="Enter Goal Percentage" class="form-control" name="goal_percentage[]" id="2014_goal_percentage"  required/> 
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Goal Figure</label>
                                                        <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[0]['fy_goal_figure']; ?>" placeholder="Enter Goal Figure" class="form-control" name="goal_figure[]" id="2014_goal_figure" required/>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label">Remarks / Note</label>
                                                        <textarea placeholder="Remarks" <?php if($readonly){ echo $readonly; } ?> class="form-control" name="remarks[]" id="2014_remarks"><?php echo $revenue_details[0]['remarks_notes']; ?></textarea>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div id="validate_div_12" >
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Financial Year</label>
                                                            <select name="year[]" <?php if($readonly){ echo $readonly; } ?> class="form-control">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Goal Percentage</label>
                                                            <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[1]['fy_goal_percentage_of_last_fy']; ?>"  placeholder="Enter Goal Percentage" class="form-control" name="goal_percentage[]" id="2015_goal_percentage" required/> 
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label">Goal Figure</label>
                                                            <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[1]['fy_goal_figure'] ?>"  placeholder="Enter Goal Figure" class="form-control" name="goal_figure[]" id="2015_goal_figure" required/>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label">Remarks / Note</label>
                                                            <textarea placeholder="Remarks" <?php if($readonly){ echo $readonly; } ?> class="form-control" name="remarks[]" id="2015_remarks"><?php echo $revenue_details[1]['remarks_notes']; ?> </textarea>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div id="validate_div_12" >
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label">Goal Percentage</label>
                                                            <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[2]['fy_goal_percentage_of_last_fy']; ?>"  placeholder="Enter Goal Percentage" class="form-control" name="goal_percentage[]" id="2016_goal_percentage"  required/> 
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label">Goal Figure</label>
                                                            <input type="text" <?php if($readonly){ echo $readonly; } ?> value="<?php echo $revenue_details[2]['fy_goal_figure'] ?>"  placeholder="Enter Goal Figure" class="form-control" name="goal_figure[]" id="2016_goal_figure" required/>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label">Remarks / Note</label>
                                                            <textarea placeholder="Remarks" <?php if($readonly){ echo $readonly; } ?>  class="form-control" name="remarks[]" id="2016_remarks"><?php echo $revenue_details[2]['remarks_notes']; ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php if($readonly==''){ ?>
                                                <div class="col-md-12">
                                                    <div class="margiv-top-5">
                                                        <button type="submit" name="add_new_cli_revenue" id="add_new_cli_revenue" class="btn green">Save</button>
                                                    </div>
                                                </div>
                                                  <?php  } ?>
