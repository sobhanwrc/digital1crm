                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Client Name:  <?php if($thisclient[0]['type']== 'I') echo $thisclient[0]['client_first_name']." ".$thisclient[0]['client_last_name']; else echo $thisclient[0]['client_first_name']; ?>
                                <?php if($thisclient[0]['add_flag']==1){ ?>
                                   <font color="red" style="margin-left: 150px;">Imported Data</font>
                                   <?php } ?>
                                </span><span class="caption-subject bold" style="margin-left: 195px;">Phone:<?php echo " ".$thisclient[0]['phone']; ?></span>
                            </div>
