                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">View Call User</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        <div class="add_form_sec">
                                            ...
                                            <form role="form" autocomplete="off" id="add_new_attorney_frm1" method="post" action="<?php echo $base_url . 'Managecalluser/edit_save/' . base64_encode($callview[0]['call_seq_no']); ?>" enctype="multipart/form-data">
...
<!--                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" placeholder="Password" class="form-control"  name="password" id="password" value="<?php if (isset($callview[0]['password'])) echo (base64_decode($callview[0]['password'])); ?>" />
                                                                </div>-->
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="date_of_appointment" id="date_of_appointment" placeholder="DD-MMM-YYYY" value="<?php if (isset($callview[0]['date_of_appointment'])) echo $callview[0]['date_of_appointment']; ?>" >
