                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Manage Call Users</span>
                            </div>
                            <!--                                    <div class="actions">
                            ...
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6" style=" padding-left: 0">
                                        <div class="btn-group">
                                            <a href="<?php echo $base_url; ?>Managecalluser/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $base_url . 'Managecalluser/details/'. base64_encode($value['call_seq_no']); ?>">
                                                            <i class="icon-docs"></i> View </a>
                                                    </li>
                                                    
                                                   
                                                  <li>
                                                        <a href="<?php echo $base_url . 'Managecalluser/delete/' . base64_encode($value['call_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
...
<!--                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo $base_url . 'Managecalluser/edit/'. base64_encode($value['call_seq_no']); ?>">
