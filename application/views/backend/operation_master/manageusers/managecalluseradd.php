                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Add Call User</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" placeholder="Phone1" class="form-control"  name="phone1" id="phone1"  />
                                                                </div>
                                                                <div class="form-group required">
                                                                    <label class="control-label">Phone2</label>
                                                                    <input type="text" placeholder="Phone2" class="form-control"  name="phone2" id="phone2"  />
                                                                </div>
                                                                <div class="form-group required">
                                                                ...
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="date_of_appointment" id="date_of_appointment" placeholder="DD-MMM-YYYY" >
