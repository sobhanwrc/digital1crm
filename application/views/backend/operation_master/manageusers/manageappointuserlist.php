                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Manage Appointment Users</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>List</span>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Manage Appointment Users</span>
                                        <?php
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <a href="<?php echo $base_url; ?>Manageappointmentuser/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($callview as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $value['date_of_appointment']; ?>   </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="<?php echo $base_url . 'Manageappointmentuser/details/' . base64_encode($value['appt_seq_no']); ?>">
                                                                        <i class="icon-docs"></i> View </a>
                                                                </li>

                                                                <li>
                                                                    <a href="<?php echo $base_url . 'Manageappointmentuser/edit/' . base64_encode($value['appt_seq_no']); ?>">
                                                                ...
                                                                <li>
                                                                    <a href="<?php echo $base_url . 'Manageappointmentuser/delete/' . base64_encode($value['appt_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
