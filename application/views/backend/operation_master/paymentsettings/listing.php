                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Payment Settings List</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <a href="<?php echo $base_url; ?>paymentsettings/add" class="btn btn-outline sbold"  > <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php $i = 0;
                                            foreach ($payment_settings_list as $key => $val) { ?>
                                                <tr>
                                                    <td> <?php echo ++$i; ?> </td>
                                                    <td> <?php echo $val['paypal_info'] ?> </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <?php if ($role_code == 'FIRMADM') { ?>
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>paymentsettings/edit/<?php echo base64_encode($val['payment_settings_seq_no']); ?>">
                                                                            <i class="icon-docs"></i> Edit </a>
                                                                    </li>
                                                                
                                                                    <li>
                                                                        <a href="<?php echo $base_url; ?>paymentsettings/delete/<?php echo base64_encode($val['payment_settings_seq_no']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
