                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <form role="form" id="paymentsettings-general-info-edit-form" enctype="multipart/form-data" autocomplete="off" method="post" action="<?php echo $base_url . 'paymentsettings/add/' ?>" novalidate="novalidate">
...
//                                                            t($city_info);exit;
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <textarea class="form-control text-input" rows="3" placeholder="Enter Paypal Information" id="paypal_info" name="paypal_info"><?php echo set_value('paypal_info', $ci->session->userdata('paypal_info')); ?></textarea>
                                                            </div>

                                                            <div class="form-group ">
                                                                <label class="control-label">Bank Info</label>
                                                                <textarea class="form-control text-input" rows="3" placeholder="Enter Bank Information" id="bank_info" name="bank_info"><?php echo set_value('bank_info', $ci->session->userdata('bank_info')); ?></textarea>
                                                            </div>
