                ...
                <div class="page-content">
                    ...
                    <div class="page-bar" style=" position: relative">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>competitor">Module 10</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>View</span>
                                    ...
                                    <?php } }?>
                                        ...
                                        <div style=" width: 100%; margin: 0 auto;">
                                            <div style="width: 100%; display: inline-block;">
                                                ...
                                                <a class="call_now" href="javascript:void(0)" val='<?php echo $fetch_details[0]['target_seq_no']; ?>' from_model="module10" name="<?php echo $fetch_details[0]['name']; ?>"><i style="font-size: 23px; margin-left: 10px; color:#337ab7" class="fa fa-phone-square"></i></a>
                                        ...
                                        <div class="actions" style=" width: 100%; display: inline-block; margin-top: 20px;">
                                            <div class="btn-group btn-group-devided pull-right" data-toggle="buttons">
                                                <ul class="list-inline">
                                                    ...
                                                    <li>
                                                        <button style=" padding:6px 0; background-color: transparent; color:#337ab7" type="button" class="btn" data-toggle="popover" data-content="<?php echo $notes[0]['note10']; ?> " data-html="true"><i class="fa fa-code"></i> Script</button>
</li>
                                    ...
                                    <div class="main_hidediv_area">
                                        ...
                                        <div style=" width: 100%; display: inline-block; height: 50px;">
                                            <?php if($fetch_module_details[0]['content']!= ''){ ?>
                                             ...
                                             <?php } ?>
                                             <button class="btn btn-transparent dark btn-outline btn-circle active1" data-target="#client_purchase_again_div" data-toggle="modal" >Client Purchase Again</button>
              ...
              <!--                                  <button class="btn btn-transparent dark btn-outline btn-circle active" id="clicker1" style="display: none;">Hide Details <i class="fa  fa-angle-down"></i></button>-->
                                        ...
                                        <div style=" width: 100%;">
                                            ...
                                            <div class="comm_section">
                                                    ...
                                                    <li><a href="<?php echo $base_url; ?>Client_purchase/temp_email/<?php echo base64_encode($target_seq_nos); ?>/<?php echo base64_encode($company_ids); ?>" ><i class="fa fa-envelope-o"></i> Email</a></li>
                                                ...
                                                <div class="portlet light bordered">
                                                    <div class="next_date_area">
                                                        <ul class="list-unstyled">
                                                            <!-- <li><button class="btn btn-transparent dark btn-outline btn-circle active" data-target="#client_purchase_again_div" data-toggle="modal" >Client Purchase Again</button>
                                                            </li>-->
                                                            ...
                                                            <li><button class="btn btn-transparent dark btn-outline btn-circle active" data-target="#do_not_call_add_note_payment" data-toggle="modal" >Do Not Call Me</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
...
//                                                        $i = 0;
                                    ...
                                    <div class="modal fade" id="client_purchase_again_div" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <form name="purchase_again" autocomplete="off" id="purchase_again" method="post" action="<?php echo $base_url; ?>master_name/add">
                                                    ...
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                        <div class="modal-title"><span class="glyphicon glyphicon-pencil text-purple2 mr10"></span><b>Client Purchase</b></div>
                                                    </div>
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12" style=" padding-left: 0; padding-right: 0">
                                                                <div class="form-group">
                                                                    <label for="comment">Purchase Again</label>
                                                                      ...
                                                                      &nbsp;&nbsp;&nbsp;Yes<input type="radio" name="pur_agn" id="pur_agn"  value="Y">&nbsp;&nbsp;No<input type="radio" name="pur_agn" value="N" id="pur_agn">
                                    ...
                                    <div class="modal fade" id="do_not_call_add_note_payment" tabindex="-1" role="dialog"  aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-sm">
                                            <div class="modal-content">
                                                <form name="do_not_call_purchase" autocomplete="off" id="do_not_call_purchase" method="post" action="javascript:void(0)">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                    ...
                                                    <div class="modal-body">
                                                        <div id="create_event" class=" mt10">
                                                            ...
                                                            <div class="form-group" id="existing_group_field">
                                                                <div style="width: 100%"><label>Write Note</label></div>
                                                                <div class="input-group " style="width: 100%">
                                                                    <textarea name="do_not_call_notes_payment" id="do_not_call_notes_payment" cols="75" rows="5"></textarea>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <div class="input-group col-md-12" style="padding-right:15px">
                                                            <input type="button" value="Submit" class="submit btn green pull-right" name="do_not_call_client_pur_submit" id="do_not_call_client_pur_submit" >
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <div class="input-group col-md-12" style="padding-right:10px">
                                                        ...
                                                        <div id="master_name_submit_loader" style="display:none; padding-right:10px;"><font color="green"><img src="https://jygsaw.com/digital1crm/assets/img/FhHRx.gif"></font></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form name="module1_send_msg" autocomplete="off" id="module1_send_msg" method="post" action="">
                                                    ...
                                                    <div class="modal-body">
                                                        <div id="create_event" class=" mt10">
                                                            <div class="form-group" style="padding-bottom:25px;">
                                                                Mobile No. 
                                                                <input type="text" value="<?php echo $user_detail[0]['phone']; ?>" readonly placeholder="" class="form-control" id="mobile_no_for_send_tet" name="mobile_no" autocomplete="off" style="width: 85%">
                                                            </div>
                                                            <div class="form-group" style="padding-bottom:25px;">
                                                    ...
                                                    <div class="modal-footer">
                                                        <!--<button type="submit" class="create-event-form btn bg-blue2">Create Event</button>-->
                                                        <div class="input-group col-md-12 pull-right" style="padding-left:10px">
                                                            <input type="button" value="Submit" class="submit btn green pull-left" name="<?php echo $fetch_details[0]['name']; ?>" id="sendtext_submit" val='<?php echo $fetch_details[0]['target_seq_no']; ?>' from_model="module10" admin_id="<?php echo $admin_id; ?>">
                                                            <div id="master_name_submit_loader" style="display:none; padding-left:10px;"><font color="green"><img src="<?php echo $base_url; ?>assets/img/FhHRx.gif"></font></div>
                                                        </div>
                                                    </div>
                                                </form>
...
//                      var url = "https://localhost/digital1crm/api/msg_push_notification"; //checking in local server
                    ...
                    $('#edit_details_btn').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: BASE_URL + 'Client_purchase/edit_details/',
                                data: {
                               ...
                               { 
                                ...
                                else
                                {
                                 $.ajax({
                                    ...
                                    data: {
                                        do_not_call_purchase_notes:notes,
                                        target_seq_no:target_seq_no
                                    },
                                    success: function (data) {
                    ...
                    $('#add_purchase_again_submit').on('click', function (e) {
                        ...
                        if (valid) {
                            ...
                            var rad = document.querySelector('input[name = "pur_agn"]:checked').value;
                            //alert(target_seq_no);
                            ...
                            $.ajax({
                                ...
                                data: {
                                 ...
                                 beforeSend: function() {
                                    ...
                                    $('#add_purchase_again_submit').prop('disabled', true);

                                },

                                success: function (data) {
                                 $('#add_purchase_again_submit').prop('disabled', false); 

                                 if(data==1)
                                 {
                                  jconfirm({
                                           title: 'Confirmation!',
                                           content: "Client Can Again Purchase",
                                           buttons: {
                                             OK: function () {
                                                 window.location.href="<?php echo base_url();?>Client_purchase/index/";
                                              }
                                           }
                                        });
                               }
                               else if(data==2)
                               {
                                  jconfirm({
                                           title: 'Confirmation!',
                                           content: "Client Do Not Purchase Again",
                                           buttons: {
                                             OK: function () {
                                                 window.location.href="<?php echo base_url();?>Client_purchase/index/";
                                              }
                     ...
                     $('#purchase_again').validate({
                         ...
                         messages: {
                              ...
                              pur_agn: {
                                 required: "<font color=\"red\">Please Select Condition Yes/No! </font>"
                             }
                         }
                     });
