                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-dark">
                                ...
                                <span class="caption-subject bold uppercase">Module 10</span>
                            </div>
                            <!--                                    <div class="actions">
...
//                                    t($value); exit;
                                    ?>
                                    <tr style=" cursor: pointer" onclick="javascript:window.location.href='<?php echo $base_url; ?>Client_purchase/view/<?php echo base64_encode($value['target_seq_no']); ?>/<?php  echo base64_encode($value['id'])  ;?>'">

                                        <td><?php echo $SlNo++ ?></td>
                                        <?php if($value['type']=='I') { ?>
                                        <td class="border_show"><?php echo  $value['target_first_name'].' '. $value['target_last_name'];
                                        ?></td>
                                        <?php 
                                         }
                                         else
                                         {
                                         ?><td><?php echo  $value['target_first_name'].''. $value['target_last_name'];
                                        ?></td><?php } ?>
                                        <?php if($value['type']=='C') { ?>
                                        <td class="border_show"><?php echo  $value['company']; ?></td>
                                        <?php } else {?><td><?php echo  $value['company']; ?></td><?php } ?>
