                                    ...
                                    <div class="actions">
                                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm active">
                                                <input type="radio" name="options" class="toggle" id="option1"><a href="" style=" color:#fff; text-decoration: none;" onclick="history.back()"> Back</a></label>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <select class="form-control" name="firm">
                                                                            <option value="">Select One</option>
                                                                            <option value="Firm1" selected="">Attorney1</option>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <select class="form-control" name="firm">
                                                                            ...
                                                                            <?php for ($i = 2016; $i >= 1900; $i--) { ?>
                                                                                <option value="<?php echo $i; ?>" <?php if($i==2016){ ?>selected="" <?php } ?>><?php echo $i; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="200"  name="long_description" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-md-4 control-label">Current Year Goal%</label>
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="50"  name="long_description" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" value="Summery Info"  name="long_description" class="form-control " placeholder="Enter text">
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <textarea class="form-control" name="remarks" placeholder="Enter text"><?php echo 'Remark/Comments'; ?></textarea>
                                                                        <span class="help-block">  </span>
                                                                    </div>
                                                                </div>
