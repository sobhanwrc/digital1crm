                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="tab-pane active" id="tab_1_1">
                                        <form autocomplete="off" role="form" id="appprofile_info_form" method="post" action="<?php echo $base_url . 'firm-sg-sections/details/' . base64_encode($strategy_group['firm_sgsec_seq_no']); ?>">
