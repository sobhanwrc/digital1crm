                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="#responsive_<?php echo $value['group_seq_no']; ?>" data-toggle="modal">
                                                                        <i class="icon-docs"></i> View 
                                                                    </a>
                                                                </li> 
                                                                <li>
                                                                    <a href="#responsive_edit_<?php echo $value['group_seq_no']; ?>" data-toggle="modal">
    ...
    <div id="responsive" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form autocomplete="off" name="group_add_form" id="group_add_form" action="<?php echo $base_url; ?>group/add" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                     <input type="text"  name="group_name" class="form-control" placeholder="Enter group" id="prac_area_name">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                     <input type="text"  name="group_code" class="form-control" placeholder="Enter Group Code" id="prac_area_code">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="group_submit" id="group_submit" class="btn green">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
