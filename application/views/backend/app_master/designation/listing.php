                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="#responsive_<?php echo $value['designation_seq_no']; ?>" data-toggle="modal">
                                                                        <i class="icon-docs"></i> View 
                                                                    </a>
                                                                </li> 
                                                                <li>
                                                                    <a href="#responsive_edit_<?php echo $value['designation_seq_no']; ?>" data-toggle="modal">
    ...
    <div id="responsive" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form autocomplete="off" name="designation_add_form" id="designation_add_form" action="<?php echo $base_url; ?>designation/add" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                     <input type="text"  name="designation_name" class="form-control" placeholder="Enter designation" id="designation_name">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                     <input type="text"  name="designation_code" class="form-control" placeholder="Enter Designation Code" id="designation_code">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="designation_submit" id="designation_submit" class="btn green">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
