...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Presentation Setting List</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-6" style=" padding-left: 0">
                                                <div class="btn-group">
                                                    <!--<a href="<?php echo $base_url; ?>emailtemplate/add_contract" class="btn btn-outline sbold"  >--> <!-- <a href="#responsive" class="btn btn-outline sbold" data-toggle="modal" > -->
                                                        <button class="btn sbold green" data-toggle="modal" data-id="" data-industry-id="" data-target="#presentation_modal" id=""> Add New Presentation
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($getdata as $key => $val) { ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="<?php echo base_url();?>assets/upload/attachments/<?php echo $val['presentation_file_name'] ;?>"  target="_blank" "><?php echo $val['presentation_file_name']; ?></a></td>

                                                    <td>
                                                         <span><a href="javascript:void(0)" class="presentation_file_edit" data-id="<?php echo base64_encode($val['id']);?>">Edit</a></span>&nbsp;&nbsp;&nbsp;&nbsp;

                                                         <span><a href="javascript:void(0)" class="presentation_file_delete" data-id="<?php echo base64_encode($val['id']);?>">Delete</a></span>
        ...
        <div class="modal fade" id="presentation_modal" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog modal-dialog-sm">
                <div class="modal-content">
                    <form name="presentation_form" autocomplete="off" id="presentation_form" method="post" action="javascript:void(0)" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="input-group col-md-12 pull-right" style="padding-right:15px">
                                ...
                                <input type="button" value="Submit" class="submit btn green pull-right" name="presentation_submit" id="presentation_submit" >
        ...
        <div class="modal fade" id="edit_document" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog modal-dialog-sm">
                <div class="modal-content">
                    <form name="presentation_edit_form" autocomplete="off" id="presentation_edit_form" method="post" action="javascript:void(0)" enctype="multipart/form-data">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="input-group col-md-12 pull-right" style="padding-right:15px">
                                <input style=" margin-left: 15px" type="reset" value="Reset" class="submit btn green pull-right cancel" name="" id="">
                                <input type="button" value="Edit" class="submit btn green pull-right" name="presentation_edit_form_submit" id="presentation_edit_form_submit" >
...
//                    $("#loader_image").hide();
        ...
        $('#presentation_form').validate({
        	...
        	message:{
        		title_name:{
        			required: "<font color='red'>Title can't be left blank.</font>"
        		},
        		file:{
        			required: "<font color='red'>Please select file.</font>"
        		}
        	}
        });
	    ...
	    $('#presentation_submit').on('click', function(e) {
	        //alert("ok");
	       	var title_name=$('#title_name').val();
	    	var data = new FormData($('#presentation_form')[0]);

	    	var valid = $('#presentation_form').valid();
	    	if(valid){
	    		$.ajax({
			        type: "POST",
			        url: BASE_URL + 'Presentation/upload_doc',
			        data:data,
	    ...
	    $(document).on('click','.presentation_file_edit', function(e){
            var doc_id = $(this).data('id');
         	$.ajax({
                type: "POST",
                url: BASE_URL + 'Presentation/view_document',
                data:{doc_id:doc_id},
                success: function(response) {
                    var obj=$.parseJSON(response);
                    
                    $("#title_edit").val(obj[0].title);
                    $("#hid_file_name").val(obj[0].presentation_file_name);
                    $("#uid").val(obj[0].id);
                    $("#show_filename").html(obj[0].presentation_file_name);
                    $("#show_filename").attr('href',"<?php echo base_url();?>assets/upload/attachments/"+obj[0].presentation_file_name);
	    ...
	    $('#presentation_edit_form_submit').on('click', function(e) {
	       
	        var data = new FormData($('#presentation_edit_form')[0]);
	        var valid = $('#presentation_edit_form').valid();
	        if(valid){
	        	$.ajax({
			        type: "POST",
			        url: BASE_URL + 'Presentation/edit_document',
			        data:data,
			        ...
			        success: function(response) {
			            //alert(response);
			           location.href=BASE_URL + 'Presentation/';
			        },
			        error: function() {
			            //alert('Error');
			        }
  	...
  	$(document).on('click','.presentation_file_delete', function(e){
        var delt_id = $(this).data('id');
     	$.ajax({
            type: "POST",
            url: BASE_URL + 'Presentation/delete',
