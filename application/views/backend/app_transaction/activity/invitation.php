                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Invitation List</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                        <thead>
                                            <tr class="">
                                                <th style="width: 22px;"> Origin Attorney </th>
                                                <th style="width: 70px;"> Firm </th>
                                                <th style="width: 128px;"> Activity Type </th>
                                                <th style="width: 128px;"> Activity Goal </th>
                                                <th style="width: 248px;"> Strategy Group/Section  </th>
                                                <th style="width: 66px;"> Activity Reason </th>
                                                <th style="width: 46px;"> Activity Status </th>
                                                <th style="width: 95px;"> Activity Creation Date </th>
                                                <th style="width: 44px;"> Duration </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $value['act_type']; ?> </td>
                                                 <td> <?php echo $value['activity_goal']; ?> </td>
                                                <td> <?php echo $value['gsname']; ?> </td>
                                                <td> <?php echo $value['activity_reason_desc']; ?> </td>
                                                <td> <?php echo $value['act_status']; ?> </td>
                                                <td> <?php echo $value['activity_created_date']; ?> </td>
                                                <td> <?php echo $value['duration_from'] . ' - ' . $value['duration_to']; ?> </td>
                                                ...
                                                <td>
                                                   <div class="btn-group">
                                                        ...
                                                        <?php if($value['act_type'] != 'INDIVIDUAL'){ ?>
                                                            <li>
                                                                <a href="<?php echo $base_url; ?>activity/add-own-clients-targets/<?php echo base64_encode($value['activity_seq_no']); ?>">
                                                                    <i class="icon-docs"></i> Add C/T 
                                                                </a>
                                                            </li>
                                                        ...
                                                        <?php } ?>
                                                            <!--<li>
                                                                <a href="<?php echo $base_url; ?>activity/view/<?php echo base64_encode($value['activity_seq_no']); ?>">
