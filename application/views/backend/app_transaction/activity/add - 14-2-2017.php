...
<!--                                                    <select style=width:100%  class="form-control chosen-select" tabindex="8" name="goal_name" id="goal_name">
                                                        <option value></option>
                                                        <?php if (!empty($activity_name)) {

                                                    foreach ($activity_name as $k => $v) { ?>
                                                        <option value=<?php echo $v['activity_seq_no']; ?>><?php echo $v['activity_goal']; ?></option><?php }

                                                } ?></select>-->
                                                
                                                <input type="text" class="form-control typeahead" name="goal_name" id="goal_name" placeholder="Enter Activity Goal">
                                                    <span class="help-block"> </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" style="height:80px;" name="activity_reason_desc" placeholder="Enter Activity Reason"></textarea>
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group date date-picker required" data-date-format="dd-M-yyyy">
                                              ...
                                              <div class="col-md-8">
                                                 <input style=" width:90%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="activity_created_date" placeholder="DD-MMM-YYYY" value="<?php echo date('d-M-Y'); ?>">
                                                        	...
                                                        	<tr>
                                                            	<td width="100%">
                                                                	<table width="100%">
                                                                        ...
                                                                        <tr>
                                                                        	<td width="100%">
                                                                            	<input style="width:80%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="duration_from" placeholder="DD-MMM-YYYY" >
                                                             <span class="input-group-btn">
                                                                 <button class="btn default" type="button">
                                                                     <i class="fa fa-calendar"></i>
                                                                 </button>
                                                                    ...
                                                                    <tr>
                                                                        <td width="100%">
                                                                            <table width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="100%">
                                                                                        <input style="width:80%" aria-describedby="datepicker-error" aria-invalid="false" aria-required="true" class="form-control" type="text" name="duration_to" placeholder="DD-MMM-YYYY" >
                                                                     <span class="input-group-btn">
                                                                         <button class="btn default" type="button">
                                                                             <i class="fa fa-calendar"></i>
                                                                         </button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" style="height:80px;" name="remarks_notes" placeholder="Enter remarks/comments"></textarea>
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
