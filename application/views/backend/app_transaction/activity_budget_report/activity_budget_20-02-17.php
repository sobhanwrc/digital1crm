                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Marketing Budget Code - hour</h4>
                                            </div>
...
//                                                                                    t($first_value);
                                                                                ...
                                                                                ?>
                                                                        <td style=" padding: 0;">
                                                                            <table class="table" style="width: 140px; display:inline-block ">
                                                                                <tbody>
                                                                    <tr>
                                                                        <td style=" padding: 0;">
                                                                            <table style="margin-bottom: 0;" class="table">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0;  border-top: 1px solid #e7ecf1;  border-bottom: 1px solid #e7ecf1;">
                                                                            <table style="margin-bottom: 0;" class="table">
                                                                                <thead>
                                                                                <th style=" border-right: 1px solid #e7ecf1; border-bottom: none">Hours</th>
                                                                                <th style="border-right: none; border-bottom: none;">US $</th>
                                                                                </thead>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
                                                                                                ...
                                                                                                <td colspan="2" style="width: 100%; padding: 0">
                                                                                                    <table style="margin-bottom: 0;" class="table">
                                                                                                        ...
                                                                                                        <tr style="border-top: 1px solid #e7ecf1;">
                                                                                                            <td style=" border-right: 1px solid #e7ecf1;">
                                                                                                                  <?php
