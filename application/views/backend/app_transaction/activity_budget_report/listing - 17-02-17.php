                                                ...
                                                <div class="div_left"> 
                                                    <table width="100%" class="table table-bordered">
                                                      <!--Marketing Budget Codes-->  
                                                        <tr>
                                                            <td width="45%" style="height: 91px; vertical-align: middle"><strong>Marketing Budget Summary</strong></td>
                                                            <td width="20%" style="height: 91px"></td>
                                                            <td width="35%" style=" text-align:center; height: 35px; vertical-align: middle"><strong>Page Total</strong></td>
                                                        </tr>
...
//                                                                            if($value12['code']==$key11){
                                                                    ...
                                                                    <table width="100%" class="table table-bordered">
                                                                        <tr>
                                                                            <td width="45%" style=" border-top: none; height: 40px; vertical-align: middle" title="<?php echo $value12['short_description']; ?>"><strong><?php echo substr($value12['short_description'], 0, 30). '...'; ?></strong> </td>
                                                                            <td width="20%" style="height: 40px"></td>
                                                                            <td width="35%" style=" padding:0; text-align:center; height: 40px">
                                                                                <table width="100%" height="40px">
                                                                                    <tr>
                                                                                        <td width="50%" style=" border-right: 1px solid #e7ecf1; vertical-align: middle"><strong>Hours</strong></td>
                                                                                        <td width="50%" style="vertical-align: middle"><strong>US $</strong></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        foreach ($budget_code as $key22 => $value22) {
                                                                            ...
                                                                            if ($value12['code'] == $code_category_string) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="20%" style="vertical-align: middle"><?php echo $value22['code'] ?></td>
                                                                                    <td width="35%" style=" padding:0; text-align:center; height: 40px">
                                                                                        <table width="100%" style="height: 40px">
                                                                                            <tr>
                                                                                                <td width="50%" style=" border-right: 1px solid #e7ecf1; height: 40px; vertical-align: middle">
                                                                                                ...
                                                                                                <td width="50%" style="height: 40px; vertical-align: middle">
                                                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                        <tr>
                                                                            <td width="45%" style=" text-align:right; height: 35px; vertical-align: middle"><strong>Sub-total</strong></td>
                                                                            <td width="20%"></td>
                                                                            <td width="35%" style=" padding:0; text-align:center" height="35px;">
                                                                                <table width="100%" style=" height: 35px">
                                                                                    <tr>
                                                                                        <td width="50%" style=" height: 35px; border-right: 1px solid #e7ecf1; background:#ddd; color:#000; font-weight:800; vertical-align: middle">
                                                                                            <strong><?php
                                                                                        ...
                                                                                        <td width="50%" style=" height: 35px; background:#ddd; color:#000; font-weight:800; vertical-align: middle">
                                                                                            <strong><?php
...
//                                                                } 
                                                    ...
                                                    <table width="100%" class="table table-bordered">
                                                        <tr>
                                                            <td width="45%" style=" text-align:right; height: 35px; vertical-align: middle"><strong>Grand Total</strong></td>
