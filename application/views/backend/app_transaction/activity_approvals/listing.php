                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Activity Approvals List</span>
                                    </div>
                                    <!--
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        ...
                                        <tbody>
                                            <?php $i = 0; foreach ($approvals as $key => $value) { ?>
                                            <tr>
                                                <td> <?php echo ++$i; ?></td>
                                                <td> <?php echo $value['activity_name']; ?> </td>
                                                
                                                <td><?php echo code_desc($value['approval_status']); ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <?php if($value['activity_status'] == 'PENDACT'){ ?>
                                                            <li>
                                                               <a href="<?php echo $base_url; ?>activity_approvals/approve/yes/<?php echo base64_encode($value['act_approval_seq_no']); ?>"  data-toggle="modal" >
                                                                    <i class="icon-tag"></i> Approve
                                                                </a>
                                                            </li>
                                                            <li>
                                                               <a href="<?php echo $base_url; ?>activity_approvals/approve/no/<?php echo base64_encode($value['act_approval_seq_no']); ?>"  data-toggle="modal" >
                                                                    <i class="icon-tag"></i> Reject
                                                                </a>
                                                            </li>
                                                            <?php } ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Add Approvals</h4>
                        </div>
                        <form autocomplete="off" name="activity_approval_form" id="activity_approval_form" action="<?php echo $base_url; ?>activity_approvals/add" method="post">
...
<!--                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Approvers:</label>
                                                <div class="col-md-8">
                                                    <select class="form-control" name="firm">
                                                        <option value="">Select One</option>
                                                        <?php foreach ($approvers as $key => $value) { ?>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Activity Id Ref:</label>
                                                <div class="col-md-8">
                                                    <select class="form-control" name="firm">
                                                        <option value="">Select One</option>
                                                        <option value="Firm1">ID1</option>
                                                        <option value="Firm2">ID2</option>
                                                        <option value="Firm3">ID3</option>
                                                        <option value="Firm4">ID4</option>
                                                    </select>
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control date-picker" name="remarks" placeholder="Enter text">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control" name="firm">
                                                        <option value="">Select One</option>
                                                        <option value="Firm1">Pending</option>
                                                        <option value="Firm2">Confirm</option>
                                                    </select>
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
            ...
            <div id="responsive1" class="modal fade" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title">Edit Approvals</h4>
                        </div>
                        <form  name="app_codes_form" id="app_codes_form" action="<?php echo $base_url; ?>app_codes/add" method="post">
                            <div class="modal-body">
                                <div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible1="1">
                                    <div class="row">
                                        <div class="col-md-12">
