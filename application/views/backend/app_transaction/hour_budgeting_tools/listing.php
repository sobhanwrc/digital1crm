                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Hour Budgeting List</span>
                                    </div>
                                    <!--                                    <div class="actions">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_1">
                                        <thead>
                                            <tr class="">
                                                ...
                                                <?php } ?>
                                                <th> Plan Year </th>
                                                <th> Total Hours Invested </th>
                                                <th> Billable Hours </th>
                                                <th> Admin Hours </th>
                                                <th> Non Billable Case Supv </th>
                                                <th> Training Others </th>
                                                <th> Skill Dev Internal </th>
                                                <th> CLE Internal </th>
                                                <th> BPTM Hours </th>
                                                <th> Practice Area Dev </th>
                                                <th> Probono </th>
                                                <th> Recruiting </th>
                                            </tr>
                                        </thead>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text"  name="long_description" class="form-control " placeholder="Enter text">
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
